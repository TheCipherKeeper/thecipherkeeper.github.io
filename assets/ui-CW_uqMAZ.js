var lo=Object.defineProperty,Ko=Object.defineProperties,Yo=Object.getOwnPropertyDescriptor,Xo=Object.getOwnPropertyDescriptors,Ss=Object.getOwnPropertySymbols,Go=Object.prototype.hasOwnProperty,Qo=Object.prototype.propertyIsEnumerable,Fi=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),ls=t=>{throw TypeError(t)},zs=(t,e,i)=>e in t?lo(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,Qt=(t,e)=>{for(var i in e||(e={}))Go.call(e,i)&&zs(t,i,e[i]);if(Ss)for(var i of Ss(e))Qo.call(e,i)&&zs(t,i,e[i]);return t},ti=(t,e)=>Ko(t,Xo(e)),r=(t,e,i,s)=>{for(var o=s>1?void 0:s?Yo(e,i):e,a=t.length-1,n;a>=0;a--)(n=t[a])&&(o=(s?n(e,i,o):n(o))||o);return s&&o&&lo(e,i,o),o},co=(t,e,i)=>e.has(t)||ls("Cannot "+i),Zo=(t,e,i)=>(co(t,e,"read from private field"),e.get(t)),Jo=(t,e,i)=>e.has(t)?ls("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,i),tr=(t,e,i,s)=>(co(t,e,"write to private field"),e.set(t,i),i),er=function(t,e){this[0]=t,this[1]=e},ir=t=>{var e=t[Fi("asyncIterator")],i=!1,s,o={};return e==null?(e=t[Fi("iterator")](),s=a=>o[a]=n=>e[a](n)):(e=e.call(t),s=a=>o[a]=n=>{if(i){if(i=!1,a==="throw")throw n;return n}return i=!0,{done:!1,value:new er(new Promise(d=>{var c=e[a](n);c instanceof Object||ls("Object expected"),d(c)}),1)}}),o[Fi("iterator")]=()=>o,s("next"),"throw"in e?s("throw"):o.throw=a=>{throw a},"return"in e&&s("return"),o},Pe=new WeakMap,Me=new WeakMap,Re=new WeakMap,Vi=new WeakSet,hi=new WeakMap,Zt=class{constructor(t,e){this.handleFormData=i=>{const s=this.options.disabled(this.host),o=this.options.name(this.host),a=this.options.value(this.host),n=this.host.tagName.toLowerCase()==="sl-button";this.host.isConnected&&!s&&!n&&typeof o=="string"&&o.length>0&&typeof a<"u"&&(Array.isArray(a)?a.forEach(d=>{i.formData.append(o,d.toString())}):i.formData.append(o,a.toString()))},this.handleFormSubmit=i=>{var s;const o=this.options.disabled(this.host),a=this.options.reportValidity;this.form&&!this.form.noValidate&&((s=Pe.get(this.form))==null||s.forEach(n=>{this.setUserInteracted(n,!0)})),this.form&&!this.form.noValidate&&!o&&!a(this.host)&&(i.preventDefault(),i.stopImmediatePropagation())},this.handleFormReset=()=>{this.options.setValue(this.host,this.options.defaultValue(this.host)),this.setUserInteracted(this.host,!1),hi.set(this.host,[])},this.handleInteraction=i=>{const s=hi.get(this.host);s.includes(i.type)||s.push(i.type),s.length===this.options.assumeInteractionOn.length&&this.setUserInteracted(this.host,!0)},this.checkFormValidity=()=>{if(this.form&&!this.form.noValidate){const i=this.form.querySelectorAll("*");for(const s of i)if(typeof s.checkValidity=="function"&&!s.checkValidity())return!1}return!0},this.reportFormValidity=()=>{if(this.form&&!this.form.noValidate){const i=this.form.querySelectorAll("*");for(const s of i)if(typeof s.reportValidity=="function"&&!s.reportValidity())return!1}return!0},(this.host=t).addController(this),this.options=Qt({form:i=>{const s=i.form;if(s){const a=i.getRootNode().querySelector(`#${s}`);if(a)return a}return i.closest("form")},name:i=>i.name,value:i=>i.value,defaultValue:i=>i.defaultValue,disabled:i=>{var s;return(s=i.disabled)!=null?s:!1},reportValidity:i=>typeof i.reportValidity=="function"?i.reportValidity():!0,checkValidity:i=>typeof i.checkValidity=="function"?i.checkValidity():!0,setValue:(i,s)=>i.value=s,assumeInteractionOn:["sl-input"]},e)}hostConnected(){const t=this.options.form(this.host);t&&this.attachForm(t),hi.set(this.host,[]),this.options.assumeInteractionOn.forEach(e=>{this.host.addEventListener(e,this.handleInteraction)})}hostDisconnected(){this.detachForm(),hi.delete(this.host),this.options.assumeInteractionOn.forEach(t=>{this.host.removeEventListener(t,this.handleInteraction)})}hostUpdated(){const t=this.options.form(this.host);t||this.detachForm(),t&&this.form!==t&&(this.detachForm(),this.attachForm(t)),this.host.hasUpdated&&this.setValidity(this.host.validity.valid)}attachForm(t){t?(this.form=t,Pe.has(this.form)?Pe.get(this.form).add(this.host):Pe.set(this.form,new Set([this.host])),this.form.addEventListener("formdata",this.handleFormData),this.form.addEventListener("submit",this.handleFormSubmit),this.form.addEventListener("reset",this.handleFormReset),Me.has(this.form)||(Me.set(this.form,this.form.reportValidity),this.form.reportValidity=()=>this.reportFormValidity()),Re.has(this.form)||(Re.set(this.form,this.form.checkValidity),this.form.checkValidity=()=>this.checkFormValidity())):this.form=void 0}detachForm(){if(!this.form)return;const t=Pe.get(this.form);t&&(t.delete(this.host),t.size<=0&&(this.form.removeEventListener("formdata",this.handleFormData),this.form.removeEventListener("submit",this.handleFormSubmit),this.form.removeEventListener("reset",this.handleFormReset),Me.has(this.form)&&(this.form.reportValidity=Me.get(this.form),Me.delete(this.form)),Re.has(this.form)&&(this.form.checkValidity=Re.get(this.form),Re.delete(this.form)),this.form=void 0))}setUserInteracted(t,e){e?Vi.add(t):Vi.delete(t),t.requestUpdate()}doAction(t,e){if(this.form){const i=document.createElement("button");i.type=t,i.style.position="absolute",i.style.width="0",i.style.height="0",i.style.clipPath="inset(50%)",i.style.overflow="hidden",i.style.whiteSpace="nowrap",e&&(i.name=e.name,i.value=e.value,["formaction","formenctype","formmethod","formnovalidate","formtarget"].forEach(s=>{e.hasAttribute(s)&&i.setAttribute(s,e.getAttribute(s))})),this.form.append(i),i.click(),i.remove()}}getForm(){var t;return(t=this.form)!=null?t:null}reset(t){this.doAction("reset",t)}submit(t){this.doAction("submit",t)}setValidity(t){const e=this.host,i=!!Vi.has(e),s=!!e.required;e.toggleAttribute("data-required",s),e.toggleAttribute("data-optional",!s),e.toggleAttribute("data-invalid",!t),e.toggleAttribute("data-valid",t),e.toggleAttribute("data-user-invalid",!t&&i),e.toggleAttribute("data-user-valid",t&&i)}updateValidity(){const t=this.host;this.setValidity(t.validity.valid)}emitInvalidEvent(t){const e=new CustomEvent("sl-invalid",{bubbles:!1,composed:!1,cancelable:!0,detail:{}});t||e.preventDefault(),this.host.dispatchEvent(e)||t?.preventDefault()}},Ei=Object.freeze({badInput:!1,customError:!1,patternMismatch:!1,rangeOverflow:!1,rangeUnderflow:!1,stepMismatch:!1,tooLong:!1,tooShort:!1,typeMismatch:!1,valid:!0,valueMissing:!1}),sr=Object.freeze(ti(Qt({},Ei),{valid:!1,valueMissing:!0})),or=Object.freeze(ti(Qt({},Ei),{valid:!1,customError:!0}));/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vi=globalThis,cs=vi.ShadowRoot&&(vi.ShadyCSS===void 0||vi.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ds=Symbol(),As=new WeakMap;let ho=class{constructor(e,i,s){if(this._$cssResult$=!0,s!==ds)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(cs&&e===void 0){const s=i!==void 0&&i.length===1;s&&(e=As.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&As.set(i,e))}return e}toString(){return this.cssText}};const rr=t=>new ho(typeof t=="string"?t:t+"",void 0,ds),T=(t,...e)=>{const i=t.length===1?t[0]:e.reduce((s,o,a)=>s+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+t[a+1],t[0]);return new ho(i,t,ds)},ar=(t,e)=>{if(cs)t.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const s=document.createElement("style"),o=vi.litNonce;o!==void 0&&s.setAttribute("nonce",o),s.textContent=i.cssText,t.appendChild(s)}},Es=cs?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let i="";for(const s of e.cssRules)i+=s.cssText;return rr(i)})(t):t;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:nr,defineProperty:lr,getOwnPropertyDescriptor:cr,getOwnPropertyNames:dr,getOwnPropertySymbols:hr,getPrototypeOf:ur}=Object,Ti=globalThis,Ts=Ti.trustedTypes,pr=Ts?Ts.emptyScript:"",fr=Ti.reactiveElementPolyfillSupport,Ne=(t,e)=>t,$e={toAttribute(t,e){switch(e){case Boolean:t=t?pr:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=t!==null;break;case Number:i=t===null?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch{i=null}}return i}},hs=(t,e)=>!nr(t,e),Is={attribute:!0,type:String,converter:$e,reflect:!1,hasChanged:hs};Symbol.metadata??=Symbol("metadata"),Ti.litPropertyMetadata??=new WeakMap;class xe extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=Is){if(i.state&&(i.attribute=!1),this._$Ei(),this.elementProperties.set(e,i),!i.noAccessor){const s=Symbol(),o=this.getPropertyDescriptor(e,s,i);o!==void 0&&lr(this.prototype,e,o)}}static getPropertyDescriptor(e,i,s){const{get:o,set:a}=cr(this.prototype,e)??{get(){return this[i]},set(n){this[i]=n}};return{get(){return o?.call(this)},set(n){const d=o?.call(this);a.call(this,n),this.requestUpdate(e,d,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Is}static _$Ei(){if(this.hasOwnProperty(Ne("elementProperties")))return;const e=ur(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(Ne("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Ne("properties"))){const i=this.properties,s=[...dr(i),...hr(i)];for(const o of s)this.createProperty(o,i[o])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[s,o]of i)this.elementProperties.set(s,o)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const o=this._$Eu(i,s);o!==void 0&&this._$Eh.set(o,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const o of s)i.unshift(Es(o))}else e!==void 0&&i.push(Es(e));return i}static _$Eu(e,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ar(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,i,s){this._$AK(e,s)}_$EC(e,i){const s=this.constructor.elementProperties.get(e),o=this.constructor._$Eu(e,s);if(o!==void 0&&s.reflect===!0){const a=(s.converter?.toAttribute!==void 0?s.converter:$e).toAttribute(i,s.type);this._$Em=e,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._$Em=null}}_$AK(e,i){const s=this.constructor,o=s._$Eh.get(e);if(o!==void 0&&this._$Em!==o){const a=s.getPropertyOptions(o),n=typeof a.converter=="function"?{fromAttribute:a.converter}:a.converter?.fromAttribute!==void 0?a.converter:$e;this._$Em=o,this[o]=n.fromAttribute(i,a.type),this._$Em=null}}requestUpdate(e,i,s){if(e!==void 0){if(s??=this.constructor.getPropertyOptions(e),!(s.hasChanged??hs)(this[e],i))return;this.P(e,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(e,i,s){this._$AL.has(e)||this._$AL.set(e,i),s.reflect===!0&&this._$Em!==e&&(this._$Ej??=new Set).add(e)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[o,a]of this._$Ep)this[o]=a;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[o,a]of s)a.wrapped!==!0||this._$AL.has(o)||this[o]===void 0||this.P(o,this[o],a)}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(i)):this._$EU()}catch(s){throw e=!1,this._$EU(),s}e&&this._$AE(i)}willUpdate(e){}_$AE(e){this._$EO?.forEach(i=>i.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Ej&&=this._$Ej.forEach(i=>this._$EC(i,this[i])),this._$EU()}updated(e){}firstUpdated(e){}}xe.elementStyles=[],xe.shadowRootOptions={mode:"open"},xe[Ne("elementProperties")]=new Map,xe[Ne("finalized")]=new Map,fr?.({ReactiveElement:xe}),(Ti.reactiveElementVersions??=[]).push("2.0.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const us=globalThis,xi=us.trustedTypes,Os=xi?xi.createPolicy("lit-html",{createHTML:t=>t}):void 0,uo="$lit$",ee=`lit$${Math.random().toFixed(9).slice(2)}$`,po="?"+ee,mr=`<${po}>`,ue=document,Ge=()=>ue.createComment(""),Qe=t=>t===null||typeof t!="object"&&typeof t!="function",ps=Array.isArray,gr=t=>ps(t)||typeof t?.[Symbol.iterator]=="function",Bi=`[ 	
\f\r]`,Fe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ls=/-->/g,Ds=/>/g,le=RegExp(`>|${Bi}(?:([^\\s"'>=/]+)(${Bi}*=${Bi}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ps=/'/g,Ms=/"/g,fo=/^(?:script|style|textarea|title)$/i,br=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),y=br(1),kt=Symbol.for("lit-noChange"),K=Symbol.for("lit-nothing"),Rs=new WeakMap,de=ue.createTreeWalker(ue,129);function mo(t,e){if(!ps(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return Os!==void 0?Os.createHTML(e):e}const vr=(t,e)=>{const i=t.length-1,s=[];let o,a=e===2?"<svg>":e===3?"<math>":"",n=Fe;for(let d=0;d<i;d++){const c=t[d];let h,f,u=-1,p=0;for(;p<c.length&&(n.lastIndex=p,f=n.exec(c),f!==null);)p=n.lastIndex,n===Fe?f[1]==="!--"?n=Ls:f[1]!==void 0?n=Ds:f[2]!==void 0?(fo.test(f[2])&&(o=RegExp("</"+f[2],"g")),n=le):f[3]!==void 0&&(n=le):n===le?f[0]===">"?(n=o??Fe,u=-1):f[1]===void 0?u=-2:(u=n.lastIndex-f[2].length,h=f[1],n=f[3]===void 0?le:f[3]==='"'?Ms:Ps):n===Ms||n===Ps?n=le:n===Ls||n===Ds?n=Fe:(n=le,o=void 0);const m=n===le&&t[d+1].startsWith("/>")?" ":"";a+=n===Fe?c+mr:u>=0?(s.push(h),c.slice(0,u)+uo+c.slice(u)+ee+m):c+ee+(u===-2?d:m)}return[mo(t,a+(t[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class Ze{constructor({strings:e,_$litType$:i},s){let o;this.parts=[];let a=0,n=0;const d=e.length-1,c=this.parts,[h,f]=vr(e,i);if(this.el=Ze.createElement(h,s),de.currentNode=this.el.content,i===2||i===3){const u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(o=de.nextNode())!==null&&c.length<d;){if(o.nodeType===1){if(o.hasAttributes())for(const u of o.getAttributeNames())if(u.endsWith(uo)){const p=f[n++],m=o.getAttribute(u).split(ee),g=/([.?@])?(.*)/.exec(p);c.push({type:1,index:a,name:g[2],strings:m,ctor:g[1]==="."?_r:g[1]==="?"?wr:g[1]==="@"?xr:Ii}),o.removeAttribute(u)}else u.startsWith(ee)&&(c.push({type:6,index:a}),o.removeAttribute(u));if(fo.test(o.tagName)){const u=o.textContent.split(ee),p=u.length-1;if(p>0){o.textContent=xi?xi.emptyScript:"";for(let m=0;m<p;m++)o.append(u[m],Ge()),de.nextNode(),c.push({type:2,index:++a});o.append(u[p],Ge())}}}else if(o.nodeType===8)if(o.data===po)c.push({type:2,index:a});else{let u=-1;for(;(u=o.data.indexOf(ee,u+1))!==-1;)c.push({type:7,index:a}),u+=ee.length-1}a++}}static createElement(e,i){const s=ue.createElement("template");return s.innerHTML=e,s}}function Se(t,e,i=t,s){if(e===kt)return e;let o=s!==void 0?i._$Co?.[s]:i._$Cl;const a=Qe(e)?void 0:e._$litDirective$;return o?.constructor!==a&&(o?._$AO?.(!1),a===void 0?o=void 0:(o=new a(t),o._$AT(t,i,s)),s!==void 0?(i._$Co??=[])[s]=o:i._$Cl=o),o!==void 0&&(e=Se(t,o._$AS(t,e.values),o,s)),e}class yr{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:s}=this._$AD,o=(e?.creationScope??ue).importNode(i,!0);de.currentNode=o;let a=de.nextNode(),n=0,d=0,c=s[0];for(;c!==void 0;){if(n===c.index){let h;c.type===2?h=new ei(a,a.nextSibling,this,e):c.type===1?h=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(h=new kr(a,this,e)),this._$AV.push(h),c=s[++d]}n!==c?.index&&(a=de.nextNode(),n++)}return de.currentNode=ue,o}p(e){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,i),i+=s.strings.length-2):s._$AI(e[i])),i++}}class ei{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,i,s,o){this.type=2,this._$AH=K,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=s,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&e?.nodeType===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=Se(this,e,i),Qe(e)?e===K||e==null||e===""?(this._$AH!==K&&this._$AR(),this._$AH=K):e!==this._$AH&&e!==kt&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):gr(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==K&&Qe(this._$AH)?this._$AA.nextSibling.data=e:this.T(ue.createTextNode(e)),this._$AH=e}$(e){const{values:i,_$litType$:s}=e,o=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=Ze.createElement(mo(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===o)this._$AH.p(i);else{const a=new yr(o,this),n=a.u(this.options);a.p(i),this.T(n),this._$AH=a}}_$AC(e){let i=Rs.get(e.strings);return i===void 0&&Rs.set(e.strings,i=new Ze(e)),i}k(e){ps(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,o=0;for(const a of e)o===i.length?i.push(s=new ei(this.O(Ge()),this.O(Ge()),this,this.options)):s=i[o],s._$AI(a),o++;o<i.length&&(this._$AR(s&&s._$AB.nextSibling,o),i.length=o)}_$AR(e=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);e&&e!==this._$AB;){const s=e.nextSibling;e.remove(),e=s}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class Ii{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,s,o,a){this.type=1,this._$AH=K,this._$AN=void 0,this.element=e,this.name=i,this._$AM=o,this.options=a,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=K}_$AI(e,i=this,s,o){const a=this.strings;let n=!1;if(a===void 0)e=Se(this,e,i,0),n=!Qe(e)||e!==this._$AH&&e!==kt,n&&(this._$AH=e);else{const d=e;let c,h;for(e=a[0],c=0;c<a.length-1;c++)h=Se(this,d[s+c],i,c),h===kt&&(h=this._$AH[c]),n||=!Qe(h)||h!==this._$AH[c],h===K?e=K:e!==K&&(e+=(h??"")+a[c+1]),this._$AH[c]=h}n&&!o&&this.j(e)}j(e){e===K?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}let _r=class extends Ii{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===K?void 0:e}};class wr extends Ii{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==K)}}class xr extends Ii{constructor(e,i,s,o,a){super(e,i,s,o,a),this.type=5}_$AI(e,i=this){if((e=Se(this,e,i,0)??K)===kt)return;const s=this._$AH,o=e===K&&s!==K||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,a=e!==K&&(s===K||o);o&&this.element.removeEventListener(this.name,this,s),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class kr{constructor(e,i,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){Se(this,e)}}const Cr=us.litHtmlPolyfillSupport;Cr?.(Ze,ei),(us.litHtmlVersions??=[]).push("3.2.1");const $r=(t,e,i)=>{const s=i?.renderBefore??e;let o=s._$litPart$;if(o===void 0){const a=i?.renderBefore??null;s._$litPart$=o=new ei(e.insertBefore(Ge(),a),a,void 0,i??{})}return o._$AI(t),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Ue=class extends xe{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=$r(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return kt}};Ue._$litElement$=!0,Ue.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:Ue});const Sr=globalThis.litElementPolyfillSupport;Sr?.({LitElement:Ue});(globalThis.litElementVersions??=[]).push("4.1.1");var zr=T`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ar={attribute:!0,type:String,converter:$e,reflect:!1,hasChanged:hs},Er=(t=Ar,e,i)=>{const{kind:s,metadata:o}=i;let a=globalThis.litPropertyMetadata.get(o);if(a===void 0&&globalThis.litPropertyMetadata.set(o,a=new Map),a.set(i.name,t),s==="accessor"){const{name:n}=i;return{set(d){const c=e.get.call(this);e.set.call(this,d),this.requestUpdate(n,c,t)},init(d){return d!==void 0&&this.P(n,void 0,t),d}}}if(s==="setter"){const{name:n}=i;return function(d){const c=this[n];e.call(this,d),this.requestUpdate(n,c,t)}}throw Error("Unsupported decorator location: "+s)};function l(t){return(e,i)=>typeof i=="object"?Er(t,e,i):((s,o,a)=>{const n=o.hasOwnProperty(a);return o.constructor.createProperty(a,n?{...s,wrapped:!0}:s),n?Object.getOwnPropertyDescriptor(o,a):void 0})(t,e,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ii(t){return(e,i)=>{const s=typeof e=="function"?e:e[i];Object.assign(s,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Tr(t){return(e,i)=>go(e,i,{async get(){return await this.updateComplete,this.renderRoot?.querySelector(t)??null}})}var yi,z=class extends Ue{constructor(){super(),Jo(this,yi,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([t,e])=>{this.constructor.define(t,e)})}emit(t,e){const i=new CustomEvent(t,Qt({bubbles:!0,cancelable:!1,composed:!0,detail:{}},e));return this.dispatchEvent(i),i}static define(t,e=this,i={}){const s=customElements.get(t);if(!s){try{customElements.define(t,e,i)}catch{customElements.define(t,class extends e{},i)}return}let o=" (unknown version)",a=o;"version"in e&&e.version&&(o=" v"+e.version),"version"in s&&s.version&&(a=" v"+s.version),!(o&&a&&o===a)&&console.warn(`Attempted to register <${t}>${o}, but <${t}>${a} has already been registered.`)}attributeChangedCallback(t,e,i){Zo(this,yi)||(this.constructor.elementProperties.forEach((s,o)=>{s.reflect&&this[o]!=null&&this.initialReflectedProperties.set(o,this[o])}),tr(this,yi,!0)),super.attributeChangedCallback(t,e,i)}willUpdate(t){super.willUpdate(t),this.initialReflectedProperties.forEach((e,i)=>{t.has(i)&&this[i]==null&&(this[i]=e)})}};yi=new WeakMap;z.version="2.19.1";z.dependencies={};r([l()],z.prototype,"dir",2);r([l()],z.prototype,"lang",2);var fs=class extends z{render(){return y` <slot></slot> `}};fs.styles=[L,zr];fs.define("sl-visually-hidden");var Ir=T`
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
    --show-delay: 150ms;
...
`;const Xi=new Set,ke=new Map;let ce,ms="ltr",gs="en";const bo=typeof MutationObserver<"u"&&typeof document<"u"&&typeof document.documentElement<"u";if(bo){const t=new MutationObserver(yo);ms=document.documentElement.dir||"ltr",gs=document.documentElement.lang||navigator.language,t.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function vo(...t){t.map(e=>{const i=e.$code.toLowerCase();ke.has(i)?ke.set(i,Object.assign(Object.assign({},ke.get(i)),e)):ke.set(i,e),ce||(ce=e)}),yo()}function yo(){bo&&(ms=document.documentElement.dir||"ltr",gs=document.documentElement.lang||navigator.language),[...Xi.keys()].map(t=>{typeof t.requestUpdate=="function"&&t.requestUpdate()})}let Lr=class{constructor(e){this.host=e,this.host.addController(this)}hostConnected(){Xi.add(this.host)}hostDisconnected(){Xi.delete(this.host)}dir(){return`${this.host.dir||ms}`.toLowerCase()}lang(){return`${this.host.lang||gs}`.toLowerCase()}getTranslationData(e){var i,s;const o=new Intl.Locale(e.replace(/_/g,"-")),a=o?.language.toLowerCase(),n=(s=(i=o?.region)===null||i===void 0?void 0:i.toLowerCase())!==null&&s!==void 0?s:"",d=ke.get(`${a}-${n}`),c=ke.get(a);return{locale:o,language:a,region:n,primary:d,secondary:c}}exists(e,i){var s;const{primary:o,secondary:a}=this.getTranslationData((s=i.lang)!==null&&s!==void 0?s:this.lang());return i=Object.assign({includeFallback:!1},i),!!(o&&o[e]||a&&a[e]||i.includeFallback&&ce&&ce[e])}term(e,...i){const{primary:s,secondary:o}=this.getTranslationData(this.lang());let a;if(s&&s[e])a=s[e];else if(o&&o[e])a=o[e];else if(ce&&ce[e])a=ce[e];else return console.error(`No translation found for: ${String(e)}`),String(e);return typeof a=="function"?a(...i):a}date(e,i){return e=new Date(e),new Intl.DateTimeFormat(this.lang(),i).format(e)}number(e,i){return e=Number(e),isNaN(e)?"":new Intl.NumberFormat(this.lang(),i).format(e)}relativeTime(e,i,s){return new Intl.RelativeTimeFormat(this.lang(),s).format(e,i)}};var _o={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(t,e)=>`Go to slide ${t} of ${e}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:t=>t===0?"No options selected":t===1?"1 option selected":`${t} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:t=>`Slide ${t}`,toggleColorFormat:"Toggle color format"};vo(_o);var Dr=_o,H=class extends Lr{};vo(Dr);const se=Math.min,xt=Math.max,ki=Math.round,ui=Math.floor,Wt=t=>({x:t,y:t}),Pr={left:"right",right:"left",bottom:"top",top:"bottom"},Mr={start:"end",end:"start"};function Gi(t,e,i){return xt(t,se(e,i))}function Ae(t,e){return typeof t=="function"?t(e):t}function oe(t){return t.split("-")[0]}function Ee(t){return t.split("-")[1]}function wo(t){return t==="x"?"y":"x"}function bs(t){return t==="y"?"height":"width"}const Rr=new Set(["top","bottom"]);function pe(t){return Rr.has(oe(t))?"y":"x"}function vs(t){return wo(pe(t))}function Fr(t,e,i){i===void 0&&(i=!1);const s=Ee(t),o=vs(t),a=bs(o);let n=o==="x"?s===(i?"end":"start")?"right":"left":s==="start"?"bottom":"top";return e.reference[a]>e.floating[a]&&(n=Ci(n)),[n,Ci(n)]}function Vr(t){const e=Ci(t);return[Qi(t),e,Qi(e)]}function Qi(t){return t.replace(/start|end/g,e=>Mr[e])}const Fs=["left","right"],Vs=["right","left"],Br=["top","bottom"],Hr=["bottom","top"];function Nr(t,e,i){switch(t){case"top":case"bottom":return i?e?Vs:Fs:e?Fs:Vs;case"left":case"right":return e?Br:Hr;default:return[]}}function Ur(t,e,i,s){const o=Ee(t);let a=Nr(oe(t),i==="start",s);return o&&(a=a.map(n=>n+"-"+o),e&&(a=a.concat(a.map(Qi)))),a}function Ci(t){return t.replace(/left|right|bottom|top/g,e=>Pr[e])}function Wr(t){return{top:0,right:0,bottom:0,left:0,...t}}function xo(t){return typeof t!="number"?Wr(t):{top:t,right:t,bottom:t,left:t}}function $i(t){const{x:e,y:i,width:s,height:o}=t;return{width:s,height:o,top:i,left:e,right:e+s,bottom:i+o,x:e,y:i}}function Bs(t,e,i){let{reference:s,floating:o}=t;const a=pe(e),n=vs(e),d=bs(n),c=oe(e),h=a==="y",f=s.x+s.width/2-o.width/2,u=s.y+s.height/2-o.height/2,p=s[d]/2-o[d]/2;let m;switch(c){case"top":m={x:f,y:s.y-o.height};break;case"bottom":m={x:f,y:s.y+s.height};break;case"right":m={x:s.x+s.width,y:u};break;case"left":m={x:s.x-o.width,y:u};break;default:m={x:s.x,y:s.y}}switch(Ee(e)){case"start":m[n]-=p*(i&&h?-1:1);break;case"end":m[n]+=p*(i&&h?-1:1);break}return m}const qr=async(t,e,i)=>{const{placement:s="bottom",strategy:o="absolute",middleware:a=[],platform:n}=i,d=a.filter(Boolean),c=await(n.isRTL==null?void 0:n.isRTL(e));let h=await n.getElementRects({reference:t,floating:e,strategy:o}),{x:f,y:u}=Bs(h,s,c),p=s,m={},g=0;for(let v=0;v<d.length;v++){const{name:$,fn:A}=d[v],{x:w,y:C,data:b,reset:_}=await A({x:f,y:u,initialPlacement:s,placement:p,strategy:o,middlewareData:m,rects:h,platform:n,elements:{reference:t,floating:e}});f=w??f,u=C??u,m={...m,[$]:{...m[$],...b}},_&&g<=50&&(g++,typeof _=="object"&&(_.placement&&(p=_.placement),_.rects&&(h=_.rects===!0?await n.getElementRects({reference:t,floating:e,strategy:o}):_.rects),{x:f,y:u}=Bs(h,p,c)),v=-1)}return{x:f,y:u,placement:p,strategy:o,middlewareData:m}};async function ys(t,e){var i;e===void 0&&(e={});const{x:s,y:o,platform:a,rects:n,elements:d,strategy:c}=t,{boundary:h="clippingAncestors",rootBoundary:f="viewport",elementContext:u="floating",altBoundary:p=!1,padding:m=0}=Ae(e,t),g=xo(m),$=d[p?u==="floating"?"reference":"floating":u],A=$i(await a.getClippingRect({element:(i=await(a.isElement==null?void 0:a.isElement($)))==null||i?$:$.contextElement||await(a.getDocumentElement==null?void 0:a.getDocumentElement(d.floating)),boundary:h,rootBoundary:f,strategy:c})),w=u==="floating"?{x:s,y:o,width:n.floating.width,height:n.floating.height}:n.reference,C=await(a.getOffsetParent==null?void 0:a.getOffsetParent(d.floating)),b=await(a.isElement==null?void 0:a.isElement(C))?await(a.getScale==null?void 0:a.getScale(C))||{x:1,y:1}:{x:1,y:1},_=$i(a.convertOffsetParentRelativeRectToViewportRelativeRect?await a.convertOffsetParentRelativeRectToViewportRelativeRect({elements:d,rect:w,offsetParent:C,strategy:c}):w);return{top:(A.top-_.top+g.top)/b.y,bottom:(_.bottom-A.bottom+g.bottom)/b.y,left:(A.left-_.left+g.left)/b.x,right:(_.right-A.right+g.right)/b.x}}const jr=t=>({name:"arrow",options:t,async fn(e){const{x:i,y:s,placement:o,rects:a,platform:n,elements:d,middlewareData:c}=e,{element:h,padding:f=0}=Ae(t,e)||{};if(h==null)return{};const u=xo(f),p={x:i,y:s},m=vs(o),g=bs(m),v=await n.getDimensions(h),$=m==="y",A=$?"top":"left",w=$?"bottom":"right",C=$?"clientHeight":"clientWidth",b=a.reference[g]+a.reference[m]-p[m]-a.floating[g],_=p[m]-a.reference[m],D=await(n.getOffsetParent==null?void 0:n.getOffsetParent(h));let M=D?D[C]:0;(!M||!await(n.isElement==null?void 0:n.isElement(D)))&&(M=d.floating[C]||a.floating[g]);const F=b/2-_/2,P=M/2-v[g]/2-1,E=se(u[A],P),ot=se(u[w],P),tt=E,ft=M-v[g]-ot,et=M/2-v[g]/2+F,Ot=Gi(tt,et,ft),Ht=!c.arrow&&Ee(o)!=null&&et!==Ot&&a.reference[g]/2-(et<tt?E:ot)-v[g]/2<0,Nt=Ht?et<tt?et-tt:et-ft:0;return{[m]:p[m]+Nt,data:{[m]:Ot,centerOffset:et-Ot-Nt,...Ht&&{alignmentOffset:Nt}},reset:Ht}}}),Kr=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(e){var i,s;const{placement:o,middlewareData:a,rects:n,initialPlacement:d,platform:c,elements:h}=e,{mainAxis:f=!0,crossAxis:u=!0,fallbackPlacements:p,fallbackStrategy:m="bestFit",fallbackAxisSideDirection:g="none",flipAlignment:v=!0,...$}=Ae(t,e);if((i=a.arrow)!=null&&i.alignmentOffset)return{};const A=oe(o),w=pe(d),C=oe(d)===d,b=await(c.isRTL==null?void 0:c.isRTL(h.floating)),_=p||(C||!v?[Ci(d)]:Vr(d)),D=g!=="none";!p&&D&&_.push(...Ur(d,v,g,b));const M=[d,..._],F=await ys(e,$),P=[];let E=((s=a.flip)==null?void 0:s.overflows)||[];if(f&&P.push(F[A]),u){const et=Fr(o,n,b);P.push(F[et[0]],F[et[1]])}if(E=[...E,{placement:o,overflows:P}],!P.every(et=>et<=0)){var ot,tt;const et=(((ot=a.flip)==null?void 0:ot.index)||0)+1,Ot=M[et];if(Ot)return{data:{index:et,overflows:E},reset:{placement:Ot}};let Ht=(tt=E.filter(Nt=>Nt.overflows[0]<=0).sort((Nt,Jt)=>Nt.overflows[1]-Jt.overflows[1])[0])==null?void 0:tt.placement;if(!Ht)switch(m){case"bestFit":{var ft;const Nt=(ft=E.filter(Jt=>{if(D){const te=pe(Jt.placement);return te===w||te==="y"}return!0}).map(Jt=>[Jt.placement,Jt.overflows.filter(te=>te>0).reduce((te,jo)=>te+jo,0)]).sort((Jt,te)=>Jt[1]-te[1])[0])==null?void 0:ft[0];Nt&&(Ht=Nt);break}case"initialPlacement":Ht=d;break}if(o!==Ht)return{reset:{placement:Ht}}}return{}}}};async function Yr(t,e){const{placement:i,platform:s,elements:o}=t,a=await(s.isRTL==null?void 0:s.isRTL(o.floating)),n=oe(i),d=Ee(i),c=pe(i)==="y",h=["left","top"].includes(n)?-1:1,f=a&&c?-1:1,u=Ae(e,t);let{mainAxis:p,crossAxis:m,alignmentAxis:g}=typeof u=="number"?{mainAxis:u,crossAxis:0,alignmentAxis:null}:{mainAxis:u.mainAxis||0,crossAxis:u.crossAxis||0,alignmentAxis:u.alignmentAxis};return d&&typeof g=="number"&&(m=d==="end"?g*-1:g),c?{x:m*f,y:p*h}:{x:p*h,y:m*f}}const Xr=function(t){return t===void 0&&(t=0),{name:"offset",options:t,async fn(e){var i,s;const{x:o,y:a,placement:n,middlewareData:d}=e,c=await Yr(e,t);return n===((i=d.offset)==null?void 0:i.placement)&&(s=d.arrow)!=null&&s.alignmentOffset?{}:{x:o+c.x,y:a+c.y,data:{...c,placement:n}}}}},Gr=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(e){const{x:i,y:s,placement:o}=e,{mainAxis:a=!0,crossAxis:n=!1,limiter:d={fn:$=>{let{x:A,y:w}=$;return{x:A,y:w}}},...c}=Ae(t,e),h={x:i,y:s},f=await ys(e,c),u=pe(oe(o)),p=wo(u);let m=h[p],g=h[u];if(a){const $=p==="y"?"top":"left",A=p==="y"?"bottom":"right",w=m+f[$],C=m-f[A];m=Gi(w,m,C)}if(n){const $=u==="y"?"top":"left",A=u==="y"?"bottom":"right",w=g+f[$],C=g-f[A];g=Gi(w,g,C)}const v=d.fn({...e,[p]:m,[u]:g});return{...v,data:{x:v.x-i,y:v.y-s,enabled:{[p]:a,[u]:n}}}}}},Qr=function(t){return t===void 0&&(t={}),{name:"size",options:t,async fn(e){var i,s;const{placement:o,rects:a,platform:n,elements:d}=e,{apply:c=()=>{},...h}=Ae(t,e),f=await ys(e,h),u=oe(o),p=Ee(o),m=pe(o)==="y",{width:g,height:v}=a.floating;let $,A;u==="top"||u==="bottom"?($=u,A=p===(await(n.isRTL==null?void 0:n.isRTL(d.floating))?"start":"end")?"left":"right"):(A=u,$=p==="end"?"top":"bottom");const w=v-f.top-f.bottom,C=g-f.left-f.right,b=se(v-f[$],w),_=se(g-f[A],C),D=!e.middlewareData.shift;let M=b,F=_;if((i=e.middlewareData.shift)!=null&&i.enabled.x&&(F=C),(s=e.middlewareData.shift)!=null&&s.enabled.y&&(M=w),D&&!p){const E=xt(f.left,0),ot=xt(f.right,0),tt=xt(f.top,0),ft=xt(f.bottom,0);m?F=g-2*(E!==0||ot!==0?E+ot:xt(f.left,f.right)):M=v-2*(tt!==0||ft!==0?tt+ft:xt(f.top,f.bottom))}await c({...e,availableWidth:F,availableHeight:M});const P=await n.getDimensions(d.floating);return g!==P.width||v!==P.height?{reset:{rects:!0}}:{}}}};function Oi(){return typeof window<"u"}function Te(t){return ko(t)?(t.nodeName||"").toLowerCase():"#document"}function Ct(t){var e;return(t==null||(e=t.ownerDocument)==null?void 0:e.defaultView)||window}function jt(t){var e;return(e=(ko(t)?t.ownerDocument:t.document)||window.document)==null?void 0:e.documentElement}function ko(t){return Oi()?t instanceof Node||t instanceof Ct(t).Node:!1}function Lt(t){return Oi()?t instanceof Element||t instanceof Ct(t).Element:!1}function qt(t){return Oi()?t instanceof HTMLElement||t instanceof Ct(t).HTMLElement:!1}function Hs(t){return!Oi()||typeof ShadowRoot>"u"?!1:t instanceof ShadowRoot||t instanceof Ct(t).ShadowRoot}const Zr=new Set(["inline","contents"]);function si(t){const{overflow:e,overflowX:i,overflowY:s,display:o}=Dt(t);return/auto|scroll|overlay|hidden|clip/.test(e+s+i)&&!Zr.has(o)}const Jr=new Set(["table","td","th"]);function ta(t){return Jr.has(Te(t))}const ea=[":popover-open",":modal"];function Li(t){return ea.some(e=>{try{return t.matches(e)}catch{return!1}})}const ia=["transform","translate","scale","rotate","perspective"],sa=["transform","translate","scale","rotate","perspective","filter"],oa=["paint","layout","strict","content"];function Di(t){const e=_s(),i=Lt(t)?Dt(t):t;return ia.some(s=>i[s]?i[s]!=="none":!1)||(i.containerType?i.containerType!=="normal":!1)||!e&&(i.backdropFilter?i.backdropFilter!=="none":!1)||!e&&(i.filter?i.filter!=="none":!1)||sa.some(s=>(i.willChange||"").includes(s))||oa.some(s=>(i.contain||"").includes(s))}function ra(t){let e=re(t);for(;qt(e)&&!ze(e);){if(Di(e))return e;if(Li(e))return null;e=re(e)}return null}function _s(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}const aa=new Set(["html","body","#document"]);function ze(t){return aa.has(Te(t))}function Dt(t){return Ct(t).getComputedStyle(t)}function Pi(t){return Lt(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function re(t){if(Te(t)==="html")return t;const e=t.assignedSlot||t.parentNode||Hs(t)&&t.host||jt(t);return Hs(e)?e.host:e}function Co(t){const e=re(t);return ze(e)?t.ownerDocument?t.ownerDocument.body:t.body:qt(e)&&si(e)?e:Co(e)}function Je(t,e,i){var s;e===void 0&&(e=[]),i===void 0&&(i=!0);const o=Co(t),a=o===((s=t.ownerDocument)==null?void 0:s.body),n=Ct(o);if(a){const d=Zi(n);return e.concat(n,n.visualViewport||[],si(o)?o:[],d&&i?Je(d):[])}return e.concat(o,Je(o,[],i))}function Zi(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function $o(t){const e=Dt(t);let i=parseFloat(e.width)||0,s=parseFloat(e.height)||0;const o=qt(t),a=o?t.offsetWidth:i,n=o?t.offsetHeight:s,d=ki(i)!==a||ki(s)!==n;return d&&(i=a,s=n),{width:i,height:s,$:d}}function ws(t){return Lt(t)?t:t.contextElement}function Ce(t){const e=ws(t);if(!qt(e))return Wt(1);const i=e.getBoundingClientRect(),{width:s,height:o,$:a}=$o(e);let n=(a?ki(i.width):i.width)/s,d=(a?ki(i.height):i.height)/o;return(!n||!Number.isFinite(n))&&(n=1),(!d||!Number.isFinite(d))&&(d=1),{x:n,y:d}}const na=Wt(0);function So(t){const e=Ct(t);return!_s()||!e.visualViewport?na:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function la(t,e,i){return e===void 0&&(e=!1),!i||e&&i!==Ct(t)?!1:e}function fe(t,e,i,s){e===void 0&&(e=!1),i===void 0&&(i=!1);const o=t.getBoundingClientRect(),a=ws(t);let n=Wt(1);e&&(s?Lt(s)&&(n=Ce(s)):n=Ce(t));const d=la(a,i,s)?So(a):Wt(0);let c=(o.left+d.x)/n.x,h=(o.top+d.y)/n.y,f=o.width/n.x,u=o.height/n.y;if(a){const p=Ct(a),m=s&&Lt(s)?Ct(s):s;let g=p,v=Zi(g);for(;v&&s&&m!==g;){const $=Ce(v),A=v.getBoundingClientRect(),w=Dt(v),C=A.left+(v.clientLeft+parseFloat(w.paddingLeft))*$.x,b=A.top+(v.clientTop+parseFloat(w.paddingTop))*$.y;c*=$.x,h*=$.y,f*=$.x,u*=$.y,c+=C,h+=b,g=Ct(v),v=Zi(g)}}return $i({width:f,height:u,x:c,y:h})}function xs(t,e){const i=Pi(t).scrollLeft;return e?e.left+i:fe(jt(t)).left+i}function zo(t,e,i){i===void 0&&(i=!1);const s=t.getBoundingClientRect(),o=s.left+e.scrollLeft-(i?0:xs(t,s)),a=s.top+e.scrollTop;return{x:o,y:a}}function ca(t){let{elements:e,rect:i,offsetParent:s,strategy:o}=t;const a=o==="fixed",n=jt(s),d=e?Li(e.floating):!1;if(s===n||d&&a)return i;let c={scrollLeft:0,scrollTop:0},h=Wt(1);const f=Wt(0),u=qt(s);if((u||!u&&!a)&&((Te(s)!=="body"||si(n))&&(c=Pi(s)),qt(s))){const m=fe(s);h=Ce(s),f.x=m.x+s.clientLeft,f.y=m.y+s.clientTop}const p=n&&!u&&!a?zo(n,c,!0):Wt(0);return{width:i.width*h.x,height:i.height*h.y,x:i.x*h.x-c.scrollLeft*h.x+f.x+p.x,y:i.y*h.y-c.scrollTop*h.y+f.y+p.y}}function da(t){return Array.from(t.getClientRects())}function ha(t){const e=jt(t),i=Pi(t),s=t.ownerDocument.body,o=xt(e.scrollWidth,e.clientWidth,s.scrollWidth,s.clientWidth),a=xt(e.scrollHeight,e.clientHeight,s.scrollHeight,s.clientHeight);let n=-i.scrollLeft+xs(t);const d=-i.scrollTop;return Dt(s).direction==="rtl"&&(n+=xt(e.clientWidth,s.clientWidth)-o),{width:o,height:a,x:n,y:d}}function ua(t,e){const i=Ct(t),s=jt(t),o=i.visualViewport;let a=s.clientWidth,n=s.clientHeight,d=0,c=0;if(o){a=o.width,n=o.height;const h=_s();(!h||h&&e==="fixed")&&(d=o.offsetLeft,c=o.offsetTop)}return{width:a,height:n,x:d,y:c}}function pa(t,e){const i=fe(t,!0,e==="fixed"),s=i.top+t.clientTop,o=i.left+t.clientLeft,a=qt(t)?Ce(t):Wt(1),n=t.clientWidth*a.x,d=t.clientHeight*a.y,c=o*a.x,h=s*a.y;return{width:n,height:d,x:c,y:h}}function Ns(t,e,i){let s;if(e==="viewport")s=ua(t,i);else if(e==="document")s=ha(jt(t));else if(Lt(e))s=pa(e,i);else{const o=So(t);s={x:e.x-o.x,y:e.y-o.y,width:e.width,height:e.height}}return $i(s)}function Ao(t,e){const i=re(t);return i===e||!Lt(i)||ze(i)?!1:Dt(i).position==="fixed"||Ao(i,e)}function fa(t,e){const i=e.get(t);if(i)return i;let s=Je(t,[],!1).filter(d=>Lt(d)&&Te(d)!=="body"),o=null;const a=Dt(t).position==="fixed";let n=a?re(t):t;for(;Lt(n)&&!ze(n);){const d=Dt(n),c=Di(n);!c&&d.position==="fixed"&&(o=null),(a?!c&&!o:!c&&d.position==="static"&&!!o&&["absolute","fixed"].includes(o.position)||si(n)&&!c&&Ao(t,n))?s=s.filter(f=>f!==n):o=d,n=re(n)}return e.set(t,s),s}function ma(t){let{element:e,boundary:i,rootBoundary:s,strategy:o}=t;const n=[...i==="clippingAncestors"?Li(e)?[]:fa(e,this._c):[].concat(i),s],d=n[0],c=n.reduce((h,f)=>{const u=Ns(e,f,o);return h.top=xt(u.top,h.top),h.right=se(u.right,h.right),h.bottom=se(u.bottom,h.bottom),h.left=xt(u.left,h.left),h},Ns(e,d,o));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}}function ga(t){const{width:e,height:i}=$o(t);return{width:e,height:i}}function ba(t,e,i){const s=qt(e),o=jt(e),a=i==="fixed",n=fe(t,!0,a,e);let d={scrollLeft:0,scrollTop:0};const c=Wt(0);if(s||!s&&!a)if((Te(e)!=="body"||si(o))&&(d=Pi(e)),s){const p=fe(e,!0,a,e);c.x=p.x+e.clientLeft,c.y=p.y+e.clientTop}else o&&(c.x=xs(o));const h=o&&!s&&!a?zo(o,d):Wt(0),f=n.left+d.scrollLeft-c.x-h.x,u=n.top+d.scrollTop-c.y-h.y;return{x:f,y:u,width:n.width,height:n.height}}function Hi(t){return Dt(t).position==="static"}function Us(t,e){if(!qt(t)||Dt(t).position==="fixed")return null;if(e)return e(t);let i=t.offsetParent;return jt(t)===i&&(i=i.ownerDocument.body),i}function Eo(t,e){const i=Ct(t);if(Li(t))return i;if(!qt(t)){let o=re(t);for(;o&&!ze(o);){if(Lt(o)&&!Hi(o))return o;o=re(o)}return i}let s=Us(t,e);for(;s&&ta(s)&&Hi(s);)s=Us(s,e);return s&&ze(s)&&Hi(s)&&!Di(s)?i:s||ra(t)||i}const va=async function(t){const e=this.getOffsetParent||Eo,i=this.getDimensions,s=await i(t.floating);return{reference:ba(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:s.width,height:s.height}}};function ya(t){return Dt(t).direction==="rtl"}const _i={convertOffsetParentRelativeRectToViewportRelativeRect:ca,getDocumentElement:jt,getClippingRect:ma,getOffsetParent:Eo,getElementRects:va,getClientRects:da,getDimensions:ga,getScale:Ce,isElement:Lt,isRTL:ya};function To(t,e){return t.x===e.x&&t.y===e.y&&t.width===e.width&&t.height===e.height}function _a(t,e){let i=null,s;const o=jt(t);function a(){var d;clearTimeout(s),(d=i)==null||d.disconnect(),i=null}function n(d,c){d===void 0&&(d=!1),c===void 0&&(c=1),a();const h=t.getBoundingClientRect(),{left:f,top:u,width:p,height:m}=h;if(d||e(),!p||!m)return;const g=ui(u),v=ui(o.clientWidth-(f+p)),$=ui(o.clientHeight-(u+m)),A=ui(f),C={rootMargin:-g+"px "+-v+"px "+-$+"px "+-A+"px",threshold:xt(0,se(1,c))||1};let b=!0;function _(D){const M=D[0].intersectionRatio;if(M!==c){if(!b)return n();M?n(!1,M):s=setTimeout(()=>{n(!1,1e-7)},1e3)}M===1&&!To(h,t.getBoundingClientRect())&&n(),b=!1}try{i=new IntersectionObserver(_,{...C,root:o.ownerDocument})}catch{i=new IntersectionObserver(_,C)}i.observe(t)}return n(!0),a}function wa(t,e,i,s){s===void 0&&(s={});const{ancestorScroll:o=!0,ancestorResize:a=!0,elementResize:n=typeof ResizeObserver=="function",layoutShift:d=typeof IntersectionObserver=="function",animationFrame:c=!1}=s,h=ws(t),f=o||a?[...h?Je(h):[],...Je(e)]:[];f.forEach(A=>{o&&A.addEventListener("scroll",i,{passive:!0}),a&&A.addEventListener("resize",i)});const u=h&&d?_a(h,i):null;let p=-1,m=null;n&&(m=new ResizeObserver(A=>{let[w]=A;w&&w.target===h&&m&&(m.unobserve(e),cancelAnimationFrame(p),p=requestAnimationFrame(()=>{var C;(C=m)==null||C.observe(e)})),i()}),h&&!c&&m.observe(h),m.observe(e));let g,v=c?fe(t):null;c&&$();function $(){const A=fe(t);v&&!To(v,A)&&i(),v=A,g=requestAnimationFrame($)}return i(),()=>{var A;f.forEach(w=>{o&&w.removeEventListener("scroll",i),a&&w.removeEventListener("resize",i)}),u?.(),(A=m)==null||A.disconnect(),m=null,c&&cancelAnimationFrame(g)}}const xa=Xr,ka=Gr,Ca=Kr,Ws=Qr,$a=jr,Sa=(t,e,i)=>{const s=new Map,o={platform:_i,...i},a={...o.platform,_c:s};return qr(t,e,{...o,platform:a})};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ut={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},oi=t=>(...e)=>({_$litDirective$:t,values:e});let ri=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,i,s){this._$Ct=e,this._$AM=i,this._$Ci=s}_$AS(e,i){return this.update(e,i)}update(e,i){return this.render(...i)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const O=oi(class extends ri{constructor(t){if(super(t),t.type!==Ut.ATTRIBUTE||t.name!=="class"||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!this.nt?.has(s)&&this.st.add(s);return this.render(e)}const i=t.element.classList;for(const s of this.st)s in e||(i.remove(s),this.st.delete(s));for(const s in e){const o=!!e[s];o===this.st.has(s)||this.nt?.has(s)||(o?(i.add(s),this.st.add(s)):(i.remove(s),this.st.delete(s)))}return kt}});function za(t){return Aa(t)}function Ni(t){return t.assignedSlot?t.assignedSlot:t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}function Aa(t){for(let e=t;e;e=Ni(e))if(e instanceof Element&&getComputedStyle(e).display==="none")return null;for(let e=Ni(t);e;e=Ni(e)){if(!(e instanceof Element))continue;const i=getComputedStyle(e);if(i.display!=="contents"&&(i.position!=="static"||Di(i)||e.tagName==="BODY"))return e}return null}function Ea(t){return t!==null&&typeof t=="object"&&"getBoundingClientRect"in t&&("contextElement"in t?t instanceof Element:!0)}var U=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const t=this.anchorEl.getBoundingClientRect(),e=this.popup.getBoundingClientRect(),i=this.placement.includes("top")||this.placement.includes("bottom");let s=0,o=0,a=0,n=0,d=0,c=0,h=0,f=0;i?t.top<e.top?(s=t.left,o=t.bottom,a=t.right,n=t.bottom,d=e.left,c=e.top,h=e.right,f=e.top):(s=e.left,o=e.bottom,a=e.right,n=e.bottom,d=t.left,c=t.top,h=t.right,f=t.top):t.left<e.left?(s=t.right,o=t.top,a=e.left,n=e.top,d=t.right,c=t.bottom,h=e.left,f=e.bottom):(s=e.right,o=e.top,a=t.left,n=t.top,d=e.right,c=e.bottom,h=t.left,f=t.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${s}px`),this.style.setProperty("--hover-bridge-top-left-y",`${o}px`),this.style.setProperty("--hover-bridge-top-right-x",`${a}px`),this.style.setProperty("--hover-bridge-top-right-y",`${n}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${h}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${f}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(t){super.updated(t),t.has("active")&&(this.active?this.start():this.stop()),t.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const t=this.getRootNode();this.anchorEl=t.getElementById(this.anchor)}else this.anchor instanceof Element||Ea(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=wa(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(t=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>t())):t()})}reposition(){if(!this.active||!this.anchorEl)return;const t=[xa({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?t.push(Ws({apply:({rects:i})=>{const s=this.sync==="width"||this.sync==="both",o=this.sync==="height"||this.sync==="both";this.popup.style.width=s?`${i.reference.width}px`:"",this.popup.style.height=o?`${i.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&t.push(Ca({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&t.push(ka({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?t.push(Ws({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:i,availableHeight:s})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${s}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${i}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&t.push($a({element:this.arrowEl,padding:this.arrowPadding}));const e=this.strategy==="absolute"?i=>_i.getOffsetParent(i,za):_i.getOffsetParent;Sa(this.anchorEl,this.popup,{placement:this.placement,middleware:t,strategy:this.strategy,platform:ti(Qt({},_i),{getOffsetParent:e})}).then(({x:i,y:s,middlewareData:o,placement:a})=>{const n=this.localize.dir()==="rtl",d={top:"bottom",right:"left",bottom:"top",left:"right"}[a.split("-")[0]];if(this.setAttribute("data-current-placement",a),Object.assign(this.popup.style,{left:`${i}px`,top:`${s}px`}),this.arrow){const c=o.arrow.x,h=o.arrow.y;let f="",u="",p="",m="";if(this.arrowPlacement==="start"){const g=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";f=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",u=n?g:"",m=n?"":g}else if(this.arrowPlacement==="end"){const g=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";u=n?"":g,m=n?g:"",p=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(m=typeof c=="number"?"calc(50% - var(--arrow-size-diagonal))":"",f=typeof h=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(m=typeof c=="number"?`${c}px`:"",f=typeof h=="number"?`${h}px`:"");Object.assign(this.arrowEl.style,{top:f,right:u,bottom:p,left:m,[d]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return y`
    ...
    `}};nt.styles=[L,Ir];nt.dependencies={"sl-popup":U};r([k("slot:not([name])")],nt.prototype,"defaultSlot",2);r([k(".tooltip__body")],nt.prototype,"body",2);r([k("sl-popup")],nt.prototype,"popup",2);r([l()],nt.prototype,"content",2);r([l()],nt.prototype,"placement",2);r([l({type:Boolean,reflect:!0})],nt.prototype,"disabled",2);r([l({type:Number})],nt.prototype,"distance",2);r([l({type:Boolean,reflect:!0})],nt.prototype,"open",2);r([l({type:Number})],nt.prototype,"skidding",2);r([l()],nt.prototype,"trigger",2);r([l({type:Boolean})],nt.prototype,"hoist",2);r([x("open",{waitUntilFirstUpdate:!0})],nt.prototype,"handleOpenChange",1);r([x(["content","distance","hoist","placement","skidding"])],nt.prototype,"handleOptionsChange",1);r([x("disabled")],nt.prototype,"handleDisabledChange",1);W("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}});W("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});nt.define("sl-tooltip");var Oa=T`
  :host {
    /*
...
`,Ie=(t="value")=>(e,i)=>{const s=e.constructor,o=s.prototype.attributeChangedCallback;s.prototype.attributeChangedCallback=function(a,n,d){var c;const h=s.getPropertyOptions(t),f=typeof h.attribute=="string"?h.attribute:t;if(a===f){const u=h.converter||$e,m=(typeof u=="function"?u:(c=u?.fromAttribute)!=null?c:$e.fromAttribute)(d,h.type);this[t]!==m&&(this[i]=m)}o.call(this,a,n,d)}},ge=T`
...
`,vt=class{constructor(t,...e){this.slotNames=[],this.handleSlotChange=i=>{const s=i.target;(this.slotNames.includes("[default]")&&!s.name||s.name&&this.slotNames.includes(s.name))&&this.host.requestUpdate()},(this.host=t).addController(this),this.slotNames=e}hasDefaultSlot(){return[...this.host.childNodes].some(t=>{if(t.nodeType===t.TEXT_NODE&&t.textContent.trim()!=="")return!0;if(t.nodeType===t.ELEMENT_NODE){const e=t;if(e.tagName.toLowerCase()==="sl-visually-hidden")return!1;if(!e.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(t){return this.host.querySelector(`:scope > [slot="${t}"]`)!==null}test(t){return t==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(t)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}};function Pa(t){if(!t)return"";const e=t.assignedNodes({flatten:!0});let i="";return[...e].forEach(s=>{s.nodeType===Node.TEXT_NODE&&(i+=s.textContent)}),i}var Ma=T`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`,ts="";function Ks(t){ts=t}function Ra(t=""){if(!ts){const e=[...document.getElementsByTagName("script")],i=e.find(s=>s.hasAttribute("data-shoelace"));if(i)Ks(i.getAttribute("data-shoelace"));else{const s=e.find(a=>/shoelace(\.min)?\.js($|\?)/.test(a.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(a.src));let o="";s&&(o=s.getAttribute("src")),Ks(o.split("/").slice(0,-1).join("/"))}}return ts.replace(/\/$/,"")+(t?`/${t.replace(/^\//,"")}`:"")}var Fa={name:"default",resolver:t=>Ra(`assets/icons/${t}.svg`)},Va=Fa,Ys={caret:`
  ...
  `},Ba={name:"system",resolver:t=>t in Ys?`data:image/svg+xml,${encodeURIComponent(Ys[t])}`:""},Ha=Ba,Na=[Va,Ha],es=[];function Ua(t){es.push(t)}function Wa(t){es=es.filter(e=>e!==t)}function Xs(t){return Na.find(e=>e.name===t)}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qa=(t,e)=>t?._$litType$!==void 0,Oo=t=>t.strings===void 0,ja={},Ka=(t,e=ja)=>t._$AH=e;var Ve=Symbol(),pi=Symbol(),Ui,Wi=new Map,j=class extends z{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(t,e){var i;let s;if(e?.spriteSheet)return this.svg=y`<svg part="svg">
        <use part="use" href="${t}"></use>
      </svg>`,this.svg;try{if(s=await fetch(t,{mode:"cors"}),!s.ok)return s.status===410?Ve:pi}catch{return pi}try{const o=document.createElement("div");o.innerHTML=await s.text();const a=o.firstElementChild;if(((i=a?.tagName)==null?void 0:i.toLowerCase())!=="svg")return Ve;Ui||(Ui=new DOMParser);const d=Ui.parseFromString(a.outerHTML,"text/html").body.querySelector("svg");return d?(d.part.add("svg"),document.adoptNode(d)):Ve}catch{return Ve}}connectedCallback(){super.connectedCallback(),Ua(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),Wa(this)}getIconSource(){const t=Xs(this.library);return this.name&&t?{url:t.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var t;const{url:e,fromLibrary:i}=this.getIconSource(),s=i?Xs(this.library):void 0;if(!e){this.svg=null;return}let o=Wi.get(e);if(o||(o=this.resolveIcon(e,s),Wi.set(e,o)),!this.initialRender)return;const a=await o;if(a===pi&&Wi.delete(e),e===this.getIconSource().url){if(qa(a)){if(this.svg=a,s){await this.updateComplete;const n=this.shadowRoot.querySelector("[part='svg']");typeof s.mutator=="function"&&n&&s.mutator(n)}return}switch(a){case pi:case Ve:this.svg=null,this.emit("sl-error");break;default:this.svg=a.cloneNode(!0),(t=s?.mutator)==null||t.call(s,this.svg),this.emit("sl-load")}}}render(){return this.svg}};j.styles=[L,Ma];r([I()],j.prototype,"svg",2);r([l({reflect:!0})],j.prototype,"name",2);r([l()],j.prototype,"src",2);r([l()],j.prototype,"label",2);r([l({reflect:!0})],j.prototype,"library",2);r([x("label")],j.prototype,"handleLabelChange",1);r([x(["name","src","library"])],j.prototype,"setIcon",1);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const S=t=>t??K;/**
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const me=oi(class extends ri{constructor(t){if(super(t),t.type!==Ut.PROPERTY&&t.type!==Ut.ATTRIBUTE&&t.type!==Ut.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Oo(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===kt||e===K)return e;const i=t.element,s=t.name;if(t.type===Ut.PROPERTY){if(e===i[s])return kt}else if(t.type===Ut.BOOLEAN_ATTRIBUTE){if(!!e===i.hasAttribute(s))return kt}else if(t.type===Ut.ATTRIBUTE&&i.getAttribute(s)===e+"")return kt;return Ka(t),e}});var rt=class extends z{constructor(){super(...arguments),this.formControlController=new Zt(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,e)=>t.checked=e}),this.hasSlotController=new vt(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("sl-change")}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),e=this.helpText?!0:!!t;return y`
      <div
    ...
    `}};rt.styles=[L,ge,Da];rt.dependencies={"sl-icon":j};r([k('input[type="checkbox"]')],rt.prototype,"input",2);r([I()],rt.prototype,"hasFocus",2);r([l()],rt.prototype,"title",2);r([l()],rt.prototype,"name",2);r([l()],rt.prototype,"value",2);r([l({reflect:!0})],rt.prototype,"size",2);r([l({type:Boolean,reflect:!0})],rt.prototype,"disabled",2);r([l({type:Boolean,reflect:!0})],rt.prototype,"checked",2);r([l({type:Boolean,reflect:!0})],rt.prototype,"indeterminate",2);r([Ie("checked")],rt.prototype,"defaultChecked",2);r([l({reflect:!0})],rt.prototype,"form",2);r([l({type:Boolean,reflect:!0})],rt.prototype,"required",2);r([l({attribute:"help-text"})],rt.prototype,"helpText",2);r([x("disabled",{waitUntilFirstUpdate:!0})],rt.prototype,"handleDisabledChange",1);r([x(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],rt.prototype,"handleStateChange",1);var Ya=T`
  :host {
    --track-width: 2px;
...
`,ai=class extends z{constructor(){super(...arguments),this.localize=new H(this)}render(){return y`
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function Gs(t,e,i){return t?e(t):i?.(t)}var Z=class is extends z{constructor(){super(...arguments),this.localize=new H(this),this.indeterminate=!1,this.isLeaf=!1,this.loading=!1,this.selectable=!1,this.expanded=!1,this.selected=!1,this.disabled=!1,this.lazy=!1}static isTreeItem(e){return e instanceof Element&&e.getAttribute("role")==="treeitem"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","treeitem"),this.setAttribute("tabindex","-1"),this.isNestedItem()&&(this.slot="children")}firstUpdated(){this.childrenContainer.hidden=!this.expanded,this.childrenContainer.style.height=this.expanded?"auto":"0",this.isLeaf=!this.lazy&&this.getChildrenItems().length===0,this.handleExpandedChange()}async animateCollapse(){this.emit("sl-collapse"),await st(this.childrenContainer);const{keyframes:e,options:i}=Y(this,"tree-item.collapse",{dir:this.localize.dir()});await Q(this.childrenContainer,Si(e,this.childrenContainer.scrollHeight),i),this.childrenContainer.hidden=!0,this.emit("sl-after-collapse")}isNestedItem(){const e=this.parentElement;return!!e&&is.isTreeItem(e)}handleChildrenSlotChange(){this.loading=!1,this.isLeaf=!this.lazy&&this.getChildrenItems().length===0}willUpdate(e){e.has("selected")&&!e.has("indeterminate")&&(this.indeterminate=!1)}async animateExpand(){this.emit("sl-expand"),await st(this.childrenContainer),this.childrenContainer.hidden=!1;const{keyframes:e,options:i}=Y(this,"tree-item.expand",{dir:this.localize.dir()});await Q(this.childrenContainer,Si(e,this.childrenContainer.scrollHeight),i),this.childrenContainer.style.height="auto",this.emit("sl-after-expand")}handleLoadingChange(){this.setAttribute("aria-busy",this.loading?"true":"false"),this.loading||this.animateExpand()}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleExpandedChange(){this.isLeaf?this.removeAttribute("aria-expanded"):this.setAttribute("aria-expanded",this.expanded?"true":"false")}handleExpandAnimation(){this.expanded?this.lazy?(this.loading=!0,this.emit("sl-lazy-load")):this.animateExpand():this.animateCollapse()}handleLazyChange(){this.emit("sl-lazy-change")}getChildrenItems({includeDisabled:e=!0}={}){return this.childrenSlot?[...this.childrenSlot.assignedElements({flatten:!0})].filter(i=>is.isTreeItem(i)&&(e||!i.disabled)):[]}render(){const e=this.localize.dir()==="rtl",i=!this.loading&&(!this.isLeaf||this.lazy);return y`
      <div
        part="base"
    ...
    `}};be.styles=[L,Oa];r([k("slot:not([name])")],be.prototype,"defaultSlot",2);r([k("slot[name=expand-icon]")],be.prototype,"expandedIconSlot",2);r([k("slot[name=collapse-icon]")],be.prototype,"collapsedIconSlot",2);r([l()],be.prototype,"selection",2);r([x("selection")],be.prototype,"handleSelectionChange",1);be.define("sl-tree");We.define("sl-tree-item");var Xa=T`
  :host {
    --indicator-color: var(--sl-color-primary-600);
...
`,ni=class extends z{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(t=>{this.emit("sl-resize",{detail:{entries:t}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const t=this.shadowRoot.querySelector("slot");if(t!==null){const e=t.assignedElements({flatten:!0});this.observedElements.forEach(i=>this.resizeObserver.unobserve(i)),this.observedElements=[],e.forEach(i=>{this.resizeObserver.observe(i),this.observedElements.push(i)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return y` <slot @slotchange=${this.handleSlotChange}></slot> `}};ni.styles=[L,Ga];r([l({type:Boolean,reflect:!0})],ni.prototype,"disabled",2);r([x("disabled",{waitUntilFirstUpdate:!0})],ni.prototype,"handleDisabledChange",1);function Qa(t,e){return{top:Math.round(t.getBoundingClientRect().top-e.getBoundingClientRect().top),left:Math.round(t.getBoundingClientRect().left-e.getBoundingClientRect().left)}}var ss=new Set;function Za(){const t=document.documentElement.clientWidth;return Math.abs(window.innerWidth-t)}function Ja(){const t=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(t)||!t?0:t}function qe(t){if(ss.add(t),!document.documentElement.classList.contains("sl-scroll-lock")){const e=Za()+Ja();let i=getComputedStyle(document.documentElement).scrollbarGutter;(!i||i==="auto")&&(i="stable"),e<2&&(i=""),document.documentElement.style.setProperty("--sl-scroll-lock-gutter",i),document.documentElement.classList.add("sl-scroll-lock"),document.documentElement.style.setProperty("--sl-scroll-lock-size",`${e}px`)}}function je(t){ss.delete(t),ss.size===0&&(document.documentElement.classList.remove("sl-scroll-lock"),document.documentElement.style.removeProperty("--sl-scroll-lock-size"))}function os(t,e,i="vertical",s="smooth"){const o=Qa(t,e),a=o.top+e.scrollTop,n=o.left+e.scrollLeft,d=e.scrollLeft,c=e.scrollLeft+e.offsetWidth,h=e.scrollTop,f=e.scrollTop+e.offsetHeight;(i==="horizontal"||i==="both")&&(n<d?e.scrollTo({left:n,behavior:s}):n+t.clientWidth>c&&e.scrollTo({left:n-e.offsetWidth+t.clientWidth,behavior:s})),(i==="vertical"||i==="both")&&(a<h?e.scrollTo({top:a,behavior:s}):a+t.clientHeight>f&&e.scrollTo({top:a-e.offsetHeight+t.clientHeight,behavior:s}))}var tn=T`
  :host {
    display: inline-block;
    color: var(--sl-color-neutral-600);
  }
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Lo=Symbol.for(""),en=t=>{if(t?.r===Lo)return t?._$litStatic$},zi=(t,...e)=>({_$litStatic$:e.reduce((i,s,o)=>i+(a=>{if(a._$litStatic$!==void 0)return a._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${a}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(s)+t[o+1],t[0]),r:Lo}),Zs=new Map,sn=t=>(e,...i)=>{const s=i.length;let o,a;const n=[],d=[];let c,h=0,f=!1;for(;h<s;){for(c=e[h];h<s&&(a=i[h],(o=en(a))!==void 0);)c+=o+e[++h],f=!0;h!==s&&d.push(a),n.push(c),h++}if(h===s&&n.push(e[s]),f){const u=n.join("$$lit$$");(e=Zs.get(u))===void 0&&(n.raw=n,Zs.set(u,e=n)),i=d}return t(e,...i)},Ke=sn(y);var at=class extends z{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,e=t?zi`a`:zi`button`;return Ke`
      <${e}
        part="base"
...
`,N=class extends z{constructor(){super(...arguments),this.formControlController=new Zt(this,{assumeInteractionOn:["sl-blur","sl-input"]}),this.hasSlotController=new vt(this,"help-text","label"),this.hasFocus=!1,this.title="",this.name="",this.value="",this.size="medium",this.filled=!1,this.label="",this.helpText="",this.placeholder="",this.rows=4,this.resize="vertical",this.disabled=!1,this.readonly=!1,this.form="",this.required=!1,this.spellcheck=!0,this.defaultValue=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.setTextareaHeight()),this.updateComplete.then(()=>{this.setTextareaHeight(),this.resizeObserver.observe(this.input)})}firstUpdated(){this.formControlController.updateValidity()}disconnectedCallback(){var t;super.disconnectedCallback(),this.input&&((t=this.resizeObserver)==null||t.unobserve(this.input))}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleChange(){this.value=this.input.value,this.setTextareaHeight(),this.emit("sl-change")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleInput(){this.value=this.input.value,this.emit("sl-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}setTextareaHeight(){this.resize==="auto"?(this.sizeAdjuster.style.height=`${this.input.clientHeight}px`,this.input.style.height="auto",this.input.style.height=`${this.input.scrollHeight}px`):this.input.style.height=""}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleRowsChange(){this.setTextareaHeight()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity(),this.setTextareaHeight()}focus(t){this.input.focus(t)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(t){if(t){typeof t.top=="number"&&(this.input.scrollTop=t.top),typeof t.left=="number"&&(this.input.scrollLeft=t.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(t,e,i="none"){this.input.setSelectionRange(t,e,i)}setRangeText(t,e,i,s="preserve"){const o=e??this.input.selectionStart,a=i??this.input.selectionEnd;this.input.setRangeText(t,o,a,s),this.value!==this.input.value&&(this.value=this.input.value,this.setTextareaHeight())}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),i=this.label?!0:!!t,s=this.helpText?!0:!!e;return y`
    ...
    `}};N.styles=[L,ge,on];r([k(".textarea__control")],N.prototype,"input",2);r([k(".textarea__size-adjuster")],N.prototype,"sizeAdjuster",2);r([I()],N.prototype,"hasFocus",2);r([l()],N.prototype,"title",2);r([l()],N.prototype,"name",2);r([l()],N.prototype,"value",2);r([l({reflect:!0})],N.prototype,"size",2);r([l({type:Boolean,reflect:!0})],N.prototype,"filled",2);r([l()],N.prototype,"label",2);r([l({attribute:"help-text"})],N.prototype,"helpText",2);r([l()],N.prototype,"placeholder",2);r([l({type:Number})],N.prototype,"rows",2);r([l()],N.prototype,"resize",2);r([l({type:Boolean,reflect:!0})],N.prototype,"disabled",2);r([l({type:Boolean,reflect:!0})],N.prototype,"readonly",2);r([l({reflect:!0})],N.prototype,"form",2);r([l({type:Boolean,reflect:!0})],N.prototype,"required",2);r([l({type:Number})],N.prototype,"minlength",2);r([l({type:Number})],N.prototype,"maxlength",2);r([l()],N.prototype,"autocapitalize",2);r([l()],N.prototype,"autocorrect",2);r([l()],N.prototype,"autocomplete",2);r([l({type:Boolean})],N.prototype,"autofocus",2);r([l()],N.prototype,"enterkeyhint",2);r([l({type:Boolean,converter:{fromAttribute:t=>!(!t||t==="false"),toAttribute:t=>t?"true":"false"}})],N.prototype,"spellcheck",2);r([l()],N.prototype,"inputmode",2);r([Ie()],N.prototype,"defaultValue",2);r([x("disabled",{waitUntilFirstUpdate:!0})],N.prototype,"handleDisabledChange",1);r([x("rows",{waitUntilFirstUpdate:!0})],N.prototype,"handleRowsChange",1);r([x("value",{waitUntilFirstUpdate:!0})],N.prototype,"handleValueChange",1);N.define("sl-textarea");var rn=T`
  :host {
    display: inline-block;
  }
...
`,ae=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.variant="neutral",this.size="medium",this.pill=!1,this.removable=!1}handleRemoveClick(){this.emit("sl-remove")}render(){return y`
      <span
        part="base"
    ...
    `}};ae.styles=[L,rn];ae.dependencies={"sl-icon-button":at};r([l({reflect:!0})],ae.prototype,"variant",2);r([l({reflect:!0})],ae.prototype,"size",2);r([l({type:Boolean,reflect:!0})],ae.prototype,"pill",2);r([l({type:Boolean})],ae.prototype,"removable",2);ae.define("sl-tag");var an=T`
  :host {
    display: inline-block;
  }
...
`,nn=0,Pt=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.attrId=++nn,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(t){t.stopPropagation(),this.emit("sl-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,y`
      <div
        part="base"
...
`,cn=0,li=class extends z{constructor(){super(...arguments),this.attrId=++cn,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return y`
      <slot
        part="base"
        class=${O({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};li.styles=[L,ln];r([l({reflect:!0})],li.prototype,"name",2);r([l({type:Boolean,reflect:!0})],li.prototype,"active",2);r([x("active")],li.prototype,"handleActiveChange",1);li.define("sl-tab-panel");ai.define("sl-spinner");var dn=T`
  :host {
    display: inline-block;
  }
...
`,mt=class extends z{constructor(){super(...arguments),this.formControlController=new Zt(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,e)=>t.checked=e}),this.hasSlotController=new vt(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleClick(){this.checked=!this.checked,this.emit("sl-change")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleKeyDown(t){t.key==="ArrowLeft"&&(t.preventDefault(),this.checked=!1,this.emit("sl-change"),this.emit("sl-input")),t.key==="ArrowRight"&&(t.preventDefault(),this.checked=!0,this.emit("sl-change"),this.emit("sl-input"))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),e=this.helpText?!0:!!t;return y`
    ...
    `}};mt.styles=[L,ge,dn];r([k('input[type="checkbox"]')],mt.prototype,"input",2);r([I()],mt.prototype,"hasFocus",2);r([l()],mt.prototype,"title",2);r([l()],mt.prototype,"name",2);r([l()],mt.prototype,"value",2);r([l({reflect:!0})],mt.prototype,"size",2);r([l({type:Boolean,reflect:!0})],mt.prototype,"disabled",2);r([l({type:Boolean,reflect:!0})],mt.prototype,"checked",2);r([Ie("checked")],mt.prototype,"defaultChecked",2);r([l({reflect:!0})],mt.prototype,"form",2);r([l({type:Boolean,reflect:!0})],mt.prototype,"required",2);r([l({attribute:"help-text"})],mt.prototype,"helpText",2);r([x("checked",{waitUntilFirstUpdate:!0})],mt.prototype,"handleCheckedChange",1);r([x("disabled",{waitUntilFirstUpdate:!0})],mt.prototype,"handleDisabledChange",1);mt.define("sl-switch");var hn=T`
  :host {
    --divider-width: 4px;
 ...
 */let rs=class extends ri{constructor(e){if(super(e),this.it=K,e.type!==Ut.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===K||e==null)return this._t=void 0,this.it=e;if(e===kt)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const i=[e];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}};rs.directiveName="unsafeHTML",rs.resultType=1;const wi=oi(rs);var gt=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.hoverValue=0,this.isHovering=!1,this.label="",this.value=0,this.max=5,this.precision=1,this.readonly=!1,this.disabled=!1,this.getSymbol=()=>'<sl-icon name="star-fill" library="system"></sl-icon>'}getValueFromMousePosition(t){return this.getValueFromXCoordinate(t.clientX)}getValueFromTouchPosition(t){return this.getValueFromXCoordinate(t.touches[0].clientX)}getValueFromXCoordinate(t){const e=this.localize.dir()==="rtl",{left:i,right:s,width:o}=this.rating.getBoundingClientRect(),a=e?this.roundToPrecision((s-t)/o*this.max,this.precision):this.roundToPrecision((t-i)/o*this.max,this.precision);return it(a,0,this.max)}handleClick(t){this.disabled||(this.setValue(this.getValueFromMousePosition(t)),this.emit("sl-change"))}setValue(t){this.disabled||this.readonly||(this.value=t===this.value?0:t,this.isHovering=!1)}handleKeyDown(t){const e=this.localize.dir()==="ltr",i=this.localize.dir()==="rtl",s=this.value;if(!(this.disabled||this.readonly)){if(t.key==="ArrowDown"||e&&t.key==="ArrowLeft"||i&&t.key==="ArrowRight"){const o=t.shiftKey?1:this.precision;this.value=Math.max(0,this.value-o),t.preventDefault()}if(t.key==="ArrowUp"||e&&t.key==="ArrowRight"||i&&t.key==="ArrowLeft"){const o=t.shiftKey?1:this.precision;this.value=Math.min(this.max,this.value+o),t.preventDefault()}t.key==="Home"&&(this.value=0,t.preventDefault()),t.key==="End"&&(this.value=this.max,t.preventDefault()),this.value!==s&&this.emit("sl-change")}}handleMouseEnter(t){this.isHovering=!0,this.hoverValue=this.getValueFromMousePosition(t)}handleMouseMove(t){this.hoverValue=this.getValueFromMousePosition(t)}handleMouseLeave(){this.isHovering=!1}handleTouchStart(t){this.isHovering=!0,this.hoverValue=this.getValueFromTouchPosition(t),t.preventDefault()}handleTouchMove(t){this.hoverValue=this.getValueFromTouchPosition(t)}handleTouchEnd(t){this.isHovering=!1,this.setValue(this.hoverValue),this.emit("sl-change"),t.preventDefault()}roundToPrecision(t,e=.5){const i=1/e;return Math.ceil(t*i)/i}handleHoverValueChange(){this.emit("sl-hover",{detail:{phase:"move",value:this.hoverValue}})}handleIsHoveringChange(){this.emit("sl-hover",{detail:{phase:this.isHovering?"start":"end",value:this.hoverValue}})}focus(t){this.rating.focus(t)}blur(){this.rating.blur()}render(){const t=this.localize.dir()==="rtl",e=Array.from(Array(this.max).keys());let i=0;return this.disabled||this.readonly?i=this.value:i=this.isHovering?this.hoverValue:this.value,y`
    ...
    `}};gt.styles=[L,un];gt.dependencies={"sl-icon":j};r([k(".rating")],gt.prototype,"rating",2);r([I()],gt.prototype,"hoverValue",2);r([I()],gt.prototype,"isHovering",2);r([l()],gt.prototype,"label",2);r([l({type:Number})],gt.prototype,"value",2);r([l({type:Number})],gt.prototype,"max",2);r([l({type:Number})],gt.prototype,"precision",2);r([l({type:Boolean,reflect:!0})],gt.prototype,"readonly",2);r([l({type:Boolean,reflect:!0})],gt.prototype,"disabled",2);r([l()],gt.prototype,"getSymbol",2);r([ii({passive:!0})],gt.prototype,"handleTouchMove",1);r([x("hoverValue")],gt.prototype,"handleHoverValueChange",1);r([x("isHovering")],gt.prototype,"handleIsHoveringChange",1);gt.define("sl-rating");var fn=[{max:276e4,value:6e4,unit:"minute"},{max:72e6,value:36e5,unit:"hour"},{max:5184e5,value:864e5,unit:"day"},{max:24192e5,value:6048e5,unit:"week"},{max:28512e6,value:2592e6,unit:"month"},{max:1/0,value:31536e6,unit:"year"}],ve=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.isoTime="",this.relativeTime="",this.date=new Date,this.format="long",this.numeric="auto",this.sync=!1}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.updateTimeout)}render(){const t=new Date,e=new Date(this.date);if(isNaN(e.getMilliseconds()))return this.relativeTime="",this.isoTime="","";const i=e.getTime()-t.getTime(),{unit:s,value:o}=fn.find(a=>Math.abs(i)<a.max);if(this.isoTime=e.toISOString(),this.relativeTime=this.localize.relativeTime(Math.round(i/o),s,{numeric:this.numeric,style:this.format}),clearTimeout(this.updateTimeout),this.sync){let a;s==="minute"?a=fi("second"):s==="hour"?a=fi("minute"):s==="day"?a=fi("hour"):a=fi("day"),this.updateTimeout=window.setTimeout(()=>this.requestUpdate(),a)}return y` <time datetime=${this.isoTime}>${this.relativeTime}</time> `}};r([I()],ve.prototype,"isoTime",2);r([I()],ve.prototype,"relativeTime",2);r([l()],ve.prototype,"date",2);r([l()],ve.prototype,"format",2);r([l()],ve.prototype,"numeric",2);r([l({type:Boolean})],ve.prototype,"sync",2);function fi(t){const i={second:1e3,minute:6e4,hour:36e5,day:864e5}[t];return i-Date.now()%i}ve.define("sl-relative-time");var mn=T`
  :host {
    --border-radius: var(--sl-border-radius-pill);
...
`,ks=class extends z{constructor(){super(...arguments),this.effect="none"}render(){return y`
      <div
        part="base"
    ...
    `}};ks.styles=[L,mn];r([l()],ks.prototype,"effect",2);ks.define("sl-skeleton");var gn=T`
  :host {
    --thumb-size: 20px;
    --tooltip-offset: 10px;
...
`,X=class extends z{constructor(){super(...arguments),this.formControlController=new Zt(this),this.hasSlotController=new vt(this,"help-text","label"),this.localize=new H(this),this.hasFocus=!1,this.hasTooltip=!1,this.title="",this.name="",this.value=0,this.label="",this.helpText="",this.disabled=!1,this.min=0,this.max=100,this.step=1,this.tooltip="top",this.tooltipFormatter=t=>t.toString(),this.form="",this.defaultValue=0}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.syncRange()),this.value<this.min&&(this.value=this.min),this.value>this.max&&(this.value=this.max),this.updateComplete.then(()=>{this.syncRange(),this.resizeObserver.observe(this.input)})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.resizeObserver)==null||t.unobserve(this.input)}handleChange(){this.emit("sl-change")}handleInput(){this.value=parseFloat(this.input.value),this.emit("sl-input"),this.syncRange()}handleBlur(){this.hasFocus=!1,this.hasTooltip=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.hasTooltip=!0,this.emit("sl-focus")}handleThumbDragStart(){this.hasTooltip=!0}handleThumbDragEnd(){this.hasTooltip=!1}syncProgress(t){this.input.style.setProperty("--percent",`${t*100}%`)}syncTooltip(t){if(this.output!==null){const e=this.input.offsetWidth,i=this.output.offsetWidth,s=getComputedStyle(this.input).getPropertyValue("--thumb-size"),o=this.localize.dir()==="rtl",a=e*t;if(o){const n=`${e-a}px + ${t} * ${s}`;this.output.style.translate=`calc((${n} - ${i/2}px - ${s} / 2))`}else{const n=`${a}px - ${t} * ${s}`;this.output.style.translate=`calc(${n} - ${i/2}px + ${s} / 2)`}}}handleValueChange(){this.formControlController.updateValidity(),this.input.value=this.value.toString(),this.value=parseFloat(this.input.value),this.syncRange()}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}syncRange(){const t=Math.max(0,(this.value-this.min)/(this.max-this.min));this.syncProgress(t),this.tooltip!=="none"&&this.hasTooltip&&this.updateComplete.then(()=>this.syncTooltip(t))}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}focus(t){this.input.focus(t)}blur(){this.input.blur()}stepUp(){this.input.stepUp(),this.value!==Number(this.input.value)&&(this.value=Number(this.input.value))}stepDown(){this.input.stepDown(),this.value!==Number(this.input.value)&&(this.value=Number(this.input.value))}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),i=this.label?!0:!!t,s=this.helpText?!0:!!e;return y`
    ...
    `}};X.styles=[L,ge,gn];r([k(".range__control")],X.prototype,"input",2);r([k(".range__tooltip")],X.prototype,"output",2);r([I()],X.prototype,"hasFocus",2);r([I()],X.prototype,"hasTooltip",2);r([l()],X.prototype,"title",2);r([l()],X.prototype,"name",2);r([l({type:Number})],X.prototype,"value",2);r([l()],X.prototype,"label",2);r([l({attribute:"help-text"})],X.prototype,"helpText",2);r([l({type:Boolean,reflect:!0})],X.prototype,"disabled",2);r([l({type:Number})],X.prototype,"min",2);r([l({type:Number})],X.prototype,"max",2);r([l({type:Number})],X.prototype,"step",2);r([l()],X.prototype,"tooltip",2);r([l({attribute:!1})],X.prototype,"tooltipFormatter",2);r([l({reflect:!0})],X.prototype,"form",2);r([Ie()],X.prototype,"defaultValue",2);r([ii({passive:!0})],X.prototype,"handleThumbDragStart",1);r([x("value",{waitUntilFirstUpdate:!0})],X.prototype,"handleValueChange",1);r([x("disabled",{waitUntilFirstUpdate:!0})],X.prototype,"handleDisabledChange",1);r([x("hasTooltip",{waitUntilFirstUpdate:!0})],X.prototype,"syncRange",1);X.define("sl-range");var bn=T`
  :host {
    display: block;
  }
...
`,ye=class extends z{constructor(){super(...arguments),this.disableRole=!1,this.label=""}handleFocus(t){const e=Be(t.target);e?.toggleAttribute("data-sl-button-group__button--focus",!0)}handleBlur(t){const e=Be(t.target);e?.toggleAttribute("data-sl-button-group__button--focus",!1)}handleMouseOver(t){const e=Be(t.target);e?.toggleAttribute("data-sl-button-group__button--hover",!0)}handleMouseOut(t){const e=Be(t.target);e?.toggleAttribute("data-sl-button-group__button--hover",!1)}handleSlotChange(){const t=[...this.defaultSlot.assignedElements({flatten:!0})];t.forEach(e=>{const i=t.indexOf(e),s=Be(e);s&&(s.toggleAttribute("data-sl-button-group__button",!0),s.toggleAttribute("data-sl-button-group__button--first",i===0),s.toggleAttribute("data-sl-button-group__button--inner",i>0&&i<t.length-1),s.toggleAttribute("data-sl-button-group__button--last",i===t.length-1),s.toggleAttribute("data-sl-button-group__button--radio",s.tagName.toLowerCase()==="sl-radio-button"))})}render(){return y`
    ...
    `}};ut.styles=[L,ge,vn];ut.dependencies={"sl-button-group":ye};r([k("slot:not([name])")],ut.prototype,"defaultSlot",2);r([k(".radio-group__validation-input")],ut.prototype,"validationInput",2);r([I()],ut.prototype,"hasButtonGroup",2);r([I()],ut.prototype,"errorMessage",2);r([I()],ut.prototype,"defaultValue",2);r([l()],ut.prototype,"label",2);r([l({attribute:"help-text"})],ut.prototype,"helpText",2);r([l()],ut.prototype,"name",2);r([l({reflect:!0})],ut.prototype,"value",2);r([l({reflect:!0})],ut.prototype,"size",2);r([l({reflect:!0})],ut.prototype,"form",2);r([l({type:Boolean,reflect:!0})],ut.prototype,"required",2);r([x("size",{waitUntilFirstUpdate:!0})],ut.prototype,"handleSizeChange",1);r([x("value")],ut.prototype,"handleValueChange",1);ut.define("sl-radio-group");var Po=T`
  :host {
    display: inline-block;
    position: relative;
    width: auto;
...
`,Mt=class extends z{constructor(){super(...arguments),this.hasSlotController=new vt(this,"[default]","prefix","suffix"),this.hasFocus=!1,this.checked=!1,this.disabled=!1,this.size="medium",this.pill=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","presentation")}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleClick(t){if(this.disabled){t.preventDefault(),t.stopPropagation();return}this.checked=!0}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}focus(t){this.input.focus(t)}blur(){this.input.blur()}render(){return Ke`
    ...
    `}};Mt.styles=[L,_n];r([k(".button")],Mt.prototype,"input",2);r([k(".hidden-input")],Mt.prototype,"hiddenInput",2);r([I()],Mt.prototype,"hasFocus",2);r([l({type:Boolean,reflect:!0})],Mt.prototype,"checked",2);r([l()],Mt.prototype,"value",2);r([l({type:Boolean,reflect:!0})],Mt.prototype,"disabled",2);r([l({reflect:!0})],Mt.prototype,"size",2);r([l({type:Boolean,reflect:!0})],Mt.prototype,"pill",2);r([x("disabled",{waitUntilFirstUpdate:!0})],Mt.prototype,"handleDisabledChange",1);Mt.define("sl-radio-button");var wn=T`
  :host {
    --size: 128px;
    --track-width: 4px;
    --track-color: var(--sl-color-neutral-200);
...
`;let Mo=null;class Ro{}Ro.render=function(t,e){Mo(t,e)};self.QrCreator=Ro;(function(t){function e(d,c,h,f){var u={},p=t(h,c);p.u(d),p.J(),f=f||0;var m=p.h(),g=p.h()+2*f;return u.text=d,u.level=c,u.version=h,u.O=g,u.a=function(v,$){return v-=f,$-=f,0>v||v>=m||0>$||$>=m?!1:p.a(v,$)},u}function i(d,c,h,f,u,p,m,g,v,$){function A(w,C,b,_,D,M,F){w?(d.lineTo(C+M,b+F),d.arcTo(C,b,_,D,p)):d.lineTo(C,b)}m?d.moveTo(c+p,h):d.moveTo(c,h),A(g,f,h,f,u,-p,0),A(v,f,u,c,u,0,-p),A($,c,u,c,h,p,0),A(m,c,h,f,h,0,p)}function s(d,c,h,f,u,p,m,g,v,$){function A(w,C,b,_){d.moveTo(w+b,C),d.lineTo(w,C),d.lineTo(w,C+_),d.arcTo(w,C,w+b,C,p)}m&&A(c,h,p,p),g&&A(f,h,-p,p),v&&A(f,u,-p,-p),$&&A(c,u,p,-p)}function o(d,c){var h=c.fill;if(typeof h=="string")d.fillStyle=h;else{var f=h.type,u=h.colorStops;if(h=h.position.map(m=>Math.round(m*c.size)),f==="linear-gradient")var p=d.createLinearGradient.apply(d,h);else if(f==="radial-gradient")p=d.createRadialGradient.apply(d,h);else throw Error("Unsupported fill");u.forEach(([m,g])=>{p.addColorStop(m,g)}),d.fillStyle=p}}function a(d,c){t:{var h=c.text,f=c.v,u=c.N,p=c.K,m=c.P;for(u=Math.max(1,u||1),p=Math.min(40,p||40);u<=p;u+=1)try{var g=e(h,f,u,m);break t}catch{}g=void 0}if(!g)return null;for(h=d.getContext("2d"),c.background&&(h.fillStyle=c.background,h.fillRect(c.left,c.top,c.size,c.size)),f=g.O,p=c.size/f,h.beginPath(),m=0;m<f;m+=1)for(u=0;u<f;u+=1){var v=h,$=c.left+u*p,A=c.top+m*p,w=m,C=u,b=g.a,_=$+p,D=A+p,M=w-1,F=w+1,P=C-1,E=C+1,ot=Math.floor(Math.min(.5,Math.max(0,c.R))*p),tt=b(w,C),ft=b(M,P),et=b(M,C);M=b(M,E);var Ot=b(w,E);E=b(F,E),C=b(F,C),F=b(F,P),w=b(w,P),$=Math.round($),A=Math.round(A),_=Math.round(_),D=Math.round(D),tt?i(v,$,A,_,D,ot,!et&&!w,!et&&!Ot,!C&&!Ot,!C&&!w):s(v,$,A,_,D,ot,et&&w&&ft,et&&Ot&&M,C&&Ot&&E,C&&w&&F)}return o(h,c),h.fill(),d}var n={minVersion:1,maxVersion:40,ecLevel:"L",left:0,top:0,size:200,fill:"#000",background:null,text:"no text",radius:.5,quiet:0};Mo=function(d,c){var h={};Object.assign(h,n,d),h.N=h.minVersion,h.K=h.maxVersion,h.v=h.ecLevel,h.left=h.left,h.top=h.top,h.size=h.size,h.fill=h.fill,h.background=h.background,h.text=h.text,h.R=h.radius,h.P=h.quiet,c instanceof HTMLCanvasElement?((c.width!==h.size||c.height!==h.size)&&(c.width=h.size,c.height=h.size),c.getContext("2d").clearRect(0,0,c.width,c.height),a(c,h)):(d=document.createElement("canvas"),d.width=h.size,d.height=h.size,h=a(d,h),c.appendChild(h))}})(function(){function t(c){var h=i.s(c);return{S:function(){return 4},b:function(){return h.length},write:function(f){for(var u=0;u<h.length;u+=1)f.put(h[u],8)}}}function e(){var c=[],h=0,f={B:function(){return c},c:function(u){return(c[Math.floor(u/8)]>>>7-u%8&1)==1},put:function(u,p){for(var m=0;m<p;m+=1)f.m((u>>>p-m-1&1)==1)},f:function(){return h},m:function(u){var p=Math.floor(h/8);c.length<=p&&c.push(0),u&&(c[p]|=128>>>h%8),h+=1}};return f}function i(c,h){function f(w,C){for(var b=-1;7>=b;b+=1)if(!(-1>=w+b||g<=w+b))for(var _=-1;7>=_;_+=1)-1>=C+_||g<=C+_||(m[w+b][C+_]=0<=b&&6>=b&&(_==0||_==6)||0<=_&&6>=_&&(b==0||b==6)||2<=b&&4>=b&&2<=_&&4>=_)}function u(w,C){for(var b=g=4*c+17,_=Array(b),D=0;D<b;D+=1){_[D]=Array(b);for(var M=0;M<b;M+=1)_[D][M]=null}for(m=_,f(0,0),f(g-7,0),f(0,g-7),b=a.G(c),_=0;_<b.length;_+=1)for(D=0;D<b.length;D+=1){M=b[_];var F=b[D];if(m[M][F]==null)for(var P=-2;2>=P;P+=1)for(var E=-2;2>=E;E+=1)m[M+P][F+E]=P==-2||P==2||E==-2||E==2||P==0&&E==0}for(b=8;b<g-8;b+=1)m[b][6]==null&&(m[b][6]=b%2==0);for(b=8;b<g-8;b+=1)m[6][b]==null&&(m[6][b]=b%2==0);for(b=a.w(p<<3|C),_=0;15>_;_+=1)D=!w&&(b>>_&1)==1,m[6>_?_:8>_?_+1:g-15+_][8]=D,m[8][8>_?g-_-1:9>_?15-_:14-_]=D;if(m[g-8][8]=!w,7<=c){for(b=a.A(c),_=0;18>_;_+=1)D=!w&&(b>>_&1)==1,m[Math.floor(_/3)][_%3+g-8-3]=D;for(_=0;18>_;_+=1)D=!w&&(b>>_&1)==1,m[_%3+g-8-3][Math.floor(_/3)]=D}if(v==null){for(w=d.I(c,p),b=e(),_=0;_<$.length;_+=1)D=$[_],b.put(4,4),b.put(D.b(),a.f(4,c)),D.write(b);for(_=D=0;_<w.length;_+=1)D+=w[_].j;if(b.f()>8*D)throw Error("code length overflow. ("+b.f()+">"+8*D+")");for(b.f()+4<=8*D&&b.put(0,4);b.f()%8!=0;)b.m(!1);for(;!(b.f()>=8*D)&&(b.put(236,8),!(b.f()>=8*D));)b.put(17,8);var ot=0;for(D=_=0,M=Array(w.length),F=Array(w.length),P=0;P<w.length;P+=1){var tt=w[P].j,ft=w[P].o-tt;for(_=Math.max(_,tt),D=Math.max(D,ft),M[P]=Array(tt),E=0;E<M[P].length;E+=1)M[P][E]=255&b.B()[E+ot];for(ot+=tt,E=a.C(ft),tt=s(M[P],E.b()-1).l(E),F[P]=Array(E.b()-1),E=0;E<F[P].length;E+=1)ft=E+tt.b()-F[P].length,F[P][E]=0<=ft?tt.c(ft):0}for(E=b=0;E<w.length;E+=1)b+=w[E].o;for(b=Array(b),E=ot=0;E<_;E+=1)for(P=0;P<w.length;P+=1)E<M[P].length&&(b[ot]=M[P][E],ot+=1);for(E=0;E<D;E+=1)for(P=0;P<w.length;P+=1)E<F[P].length&&(b[ot]=F[P][E],ot+=1);v=b}for(w=v,b=-1,_=g-1,D=7,M=0,C=a.F(C),F=g-1;0<F;F-=2)for(F==6&&--F;;){for(P=0;2>P;P+=1)m[_][F-P]==null&&(E=!1,M<w.length&&(E=(w[M]>>>D&1)==1),C(_,F-P)&&(E=!E),m[_][F-P]=E,--D,D==-1&&(M+=1,D=7));if(_+=b,0>_||g<=_){_-=b,b=-b;break}}}var p=o[h],m=null,g=0,v=null,$=[],A={u:function(w){w=t(w),$.push(w),v=null},a:function(w,C){if(0>w||g<=w||0>C||g<=C)throw Error(w+","+C);return m[w][C]},h:function(){return g},J:function(){for(var w=0,C=0,b=0;8>b;b+=1){u(!0,b);var _=a.D(A);(b==0||w>_)&&(w=_,C=b)}u(!1,C)}};return A}function s(c,h){if(typeof c.length>"u")throw Error(c.length+"/"+h);var f=function(){for(var p=0;p<c.length&&c[p]==0;)p+=1;for(var m=Array(c.length-p+h),g=0;g<c.length-p;g+=1)m[g]=c[g+p];return m}(),u={c:function(p){return f[p]},b:function(){return f.length},multiply:function(p){for(var m=Array(u.b()+p.b()-1),g=0;g<u.b();g+=1)for(var v=0;v<p.b();v+=1)m[g+v]^=n.i(n.g(u.c(g))+n.g(p.c(v)));return s(m,0)},l:function(p){if(0>u.b()-p.b())return u;for(var m=n.g(u.c(0))-n.g(p.c(0)),g=Array(u.b()),v=0;v<u.b();v+=1)g[v]=u.c(v);for(v=0;v<p.b();v+=1)g[v]^=n.i(n.g(p.c(v))+m);return s(g,0).l(p)}};return u}i.s=function(c){for(var h=[],f=0;f<c.length;f++){var u=c.charCodeAt(f);128>u?h.push(u):2048>u?h.push(192|u>>6,128|u&63):55296>u||57344<=u?h.push(224|u>>12,128|u>>6&63,128|u&63):(f++,u=65536+((u&1023)<<10|c.charCodeAt(f)&1023),h.push(240|u>>18,128|u>>12&63,128|u>>6&63,128|u&63))}return h};var o={L:1,M:0,Q:3,H:2},a=function(){function c(u){for(var p=0;u!=0;)p+=1,u>>>=1;return p}var h=[[],[6,18],[6,22],[6,26],[6,30],[6,34],[6,22,38],[6,24,42],[6,26,46],[6,28,50],[6,30,54],[6,32,58],[6,34,62],[6,26,46,66],[6,26,48,70],[6,26,50,74],[6,30,54,78],[6,30,56,82],[6,30,58,86],[6,34,62,90],[6,28,50,72,94],[6,26,50,74,98],[6,30,54,78,102],[6,28,54,80,106],[6,32,58,84,110],[6,30,58,86,114],[6,34,62,90,118],[6,26,50,74,98,122],[6,30,54,78,102,126],[6,26,52,78,104,130],[6,30,56,82,108,134],[6,34,60,86,112,138],[6,30,58,86,114,142],[6,34,62,90,118,146],[6,30,54,78,102,126,150],[6,24,50,76,102,128,154],[6,28,54,80,106,132,158],[6,32,58,84,110,136,162],[6,26,54,82,110,138,166],[6,30,58,86,114,142,170]],f={w:function(u){for(var p=u<<10;0<=c(p)-c(1335);)p^=1335<<c(p)-c(1335);return(u<<10|p)^21522},A:function(u){for(var p=u<<12;0<=c(p)-c(7973);)p^=7973<<c(p)-c(7973);return u<<12|p},G:function(u){return h[u-1]},F:function(u){switch(u){case 0:return function(p,m){return(p+m)%2==0};case 1:return function(p){return p%2==0};case 2:return function(p,m){return m%3==0};case 3:return function(p,m){return(p+m)%3==0};case 4:return function(p,m){return(Math.floor(p/2)+Math.floor(m/3))%2==0};case 5:return function(p,m){return p*m%2+p*m%3==0};case 6:return function(p,m){return(p*m%2+p*m%3)%2==0};case 7:return function(p,m){return(p*m%3+(p+m)%2)%2==0};default:throw Error("bad maskPattern:"+u)}},C:function(u){for(var p=s([1],0),m=0;m<u;m+=1)p=p.multiply(s([1,n.i(m)],0));return p},f:function(u,p){if(u!=4||1>p||40<p)throw Error("mode: "+u+"; type: "+p);return 10>p?8:16},D:function(u){for(var p=u.h(),m=0,g=0;g<p;g+=1)for(var v=0;v<p;v+=1){for(var $=0,A=u.a(g,v),w=-1;1>=w;w+=1)if(!(0>g+w||p<=g+w))for(var C=-1;1>=C;C+=1)0>v+C||p<=v+C||(w!=0||C!=0)&&A==u.a(g+w,v+C)&&($+=1);5<$&&(m+=3+$-5)}for(g=0;g<p-1;g+=1)for(v=0;v<p-1;v+=1)$=0,u.a(g,v)&&($+=1),u.a(g+1,v)&&($+=1),u.a(g,v+1)&&($+=1),u.a(g+1,v+1)&&($+=1),($==0||$==4)&&(m+=3);for(g=0;g<p;g+=1)for(v=0;v<p-6;v+=1)u.a(g,v)&&!u.a(g,v+1)&&u.a(g,v+2)&&u.a(g,v+3)&&u.a(g,v+4)&&!u.a(g,v+5)&&u.a(g,v+6)&&(m+=40);for(v=0;v<p;v+=1)for(g=0;g<p-6;g+=1)u.a(g,v)&&!u.a(g+1,v)&&u.a(g+2,v)&&u.a(g+3,v)&&u.a(g+4,v)&&!u.a(g+5,v)&&u.a(g+6,v)&&(m+=40);for(v=$=0;v<p;v+=1)for(g=0;g<p;g+=1)u.a(g,v)&&($+=1);return m+=Math.abs(100*$/p/p-50)/5*10}};return f}(),n=function(){for(var c=Array(256),h=Array(256),f=0;8>f;f+=1)c[f]=1<<f;for(f=8;256>f;f+=1)c[f]=c[f-4]^c[f-5]^c[f-6]^c[f-8];for(f=0;255>f;f+=1)h[c[f]]=f;return{g:function(u){if(1>u)throw Error("glog("+u+")");return h[u]},i:function(u){for(;0>u;)u+=255;for(;256<=u;)u-=255;return c[u]}}}(),d=function(){function c(u,p){switch(p){case o.L:return h[4*(u-1)];case o.M:return h[4*(u-1)+1];case o.Q:return h[4*(u-1)+2];case o.H:return h[4*(u-1)+3]}}var h=[[1,26,19],[1,26,16],[1,26,13],[1,26,9],[1,44,34],[1,44,28],[1,44,22],[1,44,16],[1,70,55],[1,70,44],[2,35,17],[2,35,13],[1,100,80],[2,50,32],[2,50,24],[4,25,9],[1,134,108],[2,67,43],[2,33,15,2,34,16],[2,33,11,2,34,12],[2,86,68],[4,43,27],[4,43,19],[4,43,15],[2,98,78],[4,49,31],[2,32,14,4,33,15],[4,39,13,1,40,14],[2,121,97],[2,60,38,2,61,39],[4,40,18,2,41,19],[4,40,14,2,41,15],[2,146,116],[3,58,36,2,59,37],[4,36,16,4,37,17],[4,36,12,4,37,13],[2,86,68,2,87,69],[4,69,43,1,70,44],[6,43,19,2,44,20],[6,43,15,2,44,16],[4,101,81],[1,80,50,4,81,51],[4,50,22,4,51,23],[3,36,12,8,37,13],[2,116,92,2,117,93],[6,58,36,2,59,37],[4,46,20,6,47,21],[7,42,14,4,43,15],[4,133,107],[8,59,37,1,60,38],[8,44,20,4,45,21],[12,33,11,4,34,12],[3,145,115,1,146,116],[4,64,40,5,65,41],[11,36,16,5,37,17],[11,36,12,5,37,13],[5,109,87,1,110,88],[5,65,41,5,66,42],[5,54,24,7,55,25],[11,36,12,7,37,13],[5,122,98,1,123,99],[7,73,45,3,74,46],[15,43,19,2,44,20],[3,45,15,13,46,16],[1,135,107,5,136,108],[10,74,46,1,75,47],[1,50,22,15,51,23],[2,42,14,17,43,15],[5,150,120,1,151,121],[9,69,43,4,70,44],[17,50,22,1,51,23],[2,42,14,19,43,15],[3,141,113,4,142,114],[3,70,44,11,71,45],[17,47,21,4,48,22],[9,39,13,16,40,14],[3,135,107,5,136,108],[3,67,41,13,68,42],[15,54,24,5,55,25],[15,43,15,10,44,16],[4,144,116,4,145,117],[17,68,42],[17,50,22,6,51,23],[19,46,16,6,47,17],[2,139,111,7,140,112],[17,74,46],[7,54,24,16,55,25],[34,37,13],[4,151,121,5,152,122],[4,75,47,14,76,48],[11,54,24,14,55,25],[16,45,15,14,46,16],[6,147,117,4,148,118],[6,73,45,14,74,46],[11,54,24,16,55,25],[30,46,16,2,47,17],[8,132,106,4,133,107],[8,75,47,13,76,48],[7,54,24,22,55,25],[22,45,15,13,46,16],[10,142,114,2,143,115],[19,74,46,4,75,47],[28,50,22,6,51,23],[33,46,16,4,47,17],[8,152,122,4,153,123],[22,73,45,3,74,46],[8,53,23,26,54,24],[12,45,15,28,46,16],[3,147,117,10,148,118],[3,73,45,23,74,46],[4,54,24,31,55,25],[11,45,15,31,46,16],[7,146,116,7,147,117],[21,73,45,7,74,46],[1,53,23,37,54,24],[19,45,15,26,46,16],[5,145,115,10,146,116],[19,75,47,10,76,48],[15,54,24,25,55,25],[23,45,15,25,46,16],[13,145,115,3,146,116],[2,74,46,29,75,47],[42,54,24,1,55,25],[23,45,15,28,46,16],[17,145,115],[10,74,46,23,75,47],[10,54,24,35,55,25],[19,45,15,35,46,16],[17,145,115,1,146,116],[14,74,46,21,75,47],[29,54,24,19,55,25],[11,45,15,46,46,16],[13,145,115,6,146,116],[14,74,46,23,75,47],[44,54,24,7,55,25],[59,46,16,1,47,17],[12,151,121,7,152,122],[12,75,47,26,76,48],[39,54,24,14,55,25],[22,45,15,41,46,16],[6,151,121,14,152,122],[6,75,47,34,76,48],[46,54,24,10,55,25],[2,45,15,64,46,16],[17,152,122,4,153,123],[29,74,46,14,75,47],[49,54,24,10,55,25],[24,45,15,46,46,16],[4,152,122,18,153,123],[13,74,46,32,75,47],[48,54,24,14,55,25],[42,45,15,32,46,16],[20,147,117,4,148,118],[40,75,47,7,76,48],[43,54,24,22,55,25],[10,45,15,67,46,16],[19,148,118,6,149,119],[18,75,47,31,76,48],[34,54,24,34,55,25],[20,45,15,61,46,16]],f={I:function(u,p){var m=c(u,p);if(typeof m>"u")throw Error("bad rs block @ typeNumber:"+u+"/errorCorrectLevel:"+p);u=m.length/3,p=[];for(var g=0;g<u;g+=1)for(var v=m[3*g],$=m[3*g+1],A=m[3*g+2],w=0;w<v;w+=1){var C=A,b={};b.o=$,b.j=C,p.push(b)}return p}};return f}();return i}());const kn=QrCreator;var Rt=class extends z{constructor(){super(...arguments),this.value="",this.label="",this.size=128,this.fill="black",this.background="white",this.radius=0,this.errorCorrection="H"}firstUpdated(){this.generate()}generate(){this.hasUpdated&&kn.render({text:this.value,radius:this.radius,ecLevel:this.errorCorrection,fill:this.fill,background:this.background,size:this.size*2},this.canvas)}render(){var t;return y`
      ...
      ></canvas>
    `}};Rt.styles=[L,xn];r([k("canvas")],Rt.prototype,"canvas",2);r([l()],Rt.prototype,"value",2);r([l()],Rt.prototype,"label",2);r([l({type:Number})],Rt.prototype,"size",2);r([l()],Rt.prototype,"fill",2);r([l()],Rt.prototype,"background",2);r([l({type:Number})],Rt.prototype,"radius",2);r([l({attribute:"error-correction"})],Rt.prototype,"errorCorrection",2);r([x(["background","errorCorrection","fill","radius","size","value"])],Rt.prototype,"generate",1);Rt.define("sl-qr-code");var Cn=T`
  :host {
    display: block;
  }
...
`,Kt=class extends z{constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size="medium",this.disabled=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit("sl-blur")},this.handleClick=()=>{this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit("sl-focus")},this.addEventListener("blur",this.handleBlur),this.addEventListener("click",this.handleClick),this.addEventListener("focus",this.handleFocus)}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute("role","radio"),this.setAttribute("tabindex","-1"),this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleCheckedChange(){this.setAttribute("aria-checked",this.checked?"true":"false"),this.setAttribute("tabindex",this.checked?"0":"-1")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}render(){return y`
    ...
    `}};Kt.styles=[L,Cn];Kt.dependencies={"sl-icon":j};r([I()],Kt.prototype,"checked",2);r([I()],Kt.prototype,"hasFocus",2);r([l()],Kt.prototype,"value",2);r([l({reflect:!0})],Kt.prototype,"size",2);r([l({type:Boolean,reflect:!0})],Kt.prototype,"disabled",2);r([x("checked")],Kt.prototype,"handleCheckedChange",1);r([x("disabled",{waitUntilFirstUpdate:!0})],Kt.prototype,"handleDisabledChange",1);Kt.define("sl-radio");U.define("sl-popup");var $n=T`
  :host {
    display: block;
    user-select: none;
    -webkit-user-select: none;
...
`,Fo=class extends z{render(){return y` <slot part="base" class="menu-label"></slot> `}};Fo.styles=[L,An];Fo.define("sl-menu-label");var En=T`
  :host {
    display: block;
  }
...
`,Cs=class extends z{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(t){const e=["menuitem","menuitemcheckbox"],i=t.composedPath(),s=i.find(d=>{var c;return e.includes(((c=d?.getAttribute)==null?void 0:c.call(d,"role"))||"")});if(!s||i.find(d=>{var c;return((c=d?.getAttribute)==null?void 0:c.call(d,"role"))==="menu"})!==this)return;const n=s;n.type==="checkbox"&&(n.checked=!n.checked),this.emit("sl-select",{detail:{item:n}})}handleKeyDown(t){if(t.key==="Enter"||t.key===" "){const e=this.getCurrentItem();t.preventDefault(),t.stopPropagation(),e?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(t.key)){const e=this.getAllItems(),i=this.getCurrentItem();let s=i?e.indexOf(i):0;e.length>0&&(t.preventDefault(),t.stopPropagation(),t.key==="ArrowDown"?s++:t.key==="ArrowUp"?s--:t.key==="Home"?s=0:t.key==="End"&&(s=e.length-1),s<0&&(s=e.length-1),s>e.length-1&&(s=0),this.setCurrentItem(e[s]),e[s].focus())}}handleMouseDown(t){const e=t.target;this.isMenuItem(e)&&this.setCurrentItem(e)}handleSlotChange(){const t=this.getAllItems();t.length>0&&this.setCurrentItem(t[0])}isMenuItem(t){var e;return t.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((e=t.getAttribute("role"))!=null?e:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>!(t.inert||!this.isMenuItem(t)))}getCurrentItem(){return this.getAllItems().find(t=>t.getAttribute("tabindex")==="0")}setCurrentItem(t){this.getAllItems().forEach(i=>{i.setAttribute("tabindex",i===t?"0":"-1")})}render(){return y`
      <slot
        ...
        @mousedown=${this.handleMouseDown}
      ></slot>
    `}};Cs.styles=[L,Tn];r([k("slot")],Cs.prototype,"defaultSlot",2);Cs.define("sl-menu");var In=T`
  :host {
    --submenu-offset: -2px;
 ...
 */const Mn=()=>new Rn;class Rn{}const qi=new WeakMap,Fn=oi(class extends Pn{render(t){return K}update(t,[e]){const i=e!==this.Y;return i&&this.Y!==void 0&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.Y=e,this.ht=t.options?.host,this.rt(this.ct=t.element)),K}rt(t){if(this.isConnected||(t=void 0),typeof this.Y=="function"){const e=this.ht??globalThis;let i=qi.get(e);i===void 0&&(i=new WeakMap,qi.set(e,i)),i.get(this.Y)!==void 0&&this.Y.call(this.ht,void 0),i.set(this.Y,t),t!==void 0&&this.Y.call(this.ht,t)}else this.Y.value=t}get lt(){return typeof this.Y=="function"?qi.get(this.ht??globalThis)?.get(this.Y):this.Y?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});var Vn=class{constructor(t,e){this.popupRef=Mn(),this.enableSubmenuTimer=-1,this.isConnected=!1,this.isPopupConnected=!1,this.skidding=0,this.submenuOpenDelay=100,this.handleMouseMove=i=>{this.host.style.setProperty("--safe-triangle-cursor-x",`${i.clientX}px`),this.host.style.setProperty("--safe-triangle-cursor-y",`${i.clientY}px`)},this.handleMouseOver=()=>{this.hasSlotController.test("submenu")&&this.enableSubmenu()},this.handleKeyDown=i=>{switch(i.key){case"Escape":case"Tab":this.disableSubmenu();break;case"ArrowLeft":i.target!==this.host&&(i.preventDefault(),i.stopPropagation(),this.host.focus(),this.disableSubmenu());break;case"ArrowRight":case"Enter":case" ":this.handleSubmenuEntry(i);break}},this.handleClick=i=>{var s;i.target===this.host?(i.preventDefault(),i.stopPropagation()):i.target instanceof Element&&(i.target.tagName==="sl-menu-item"||(s=i.target.role)!=null&&s.startsWith("menuitem"))&&this.disableSubmenu()},this.handleFocusOut=i=>{i.relatedTarget&&i.relatedTarget instanceof Element&&this.host.contains(i.relatedTarget)||this.disableSubmenu()},this.handlePopupMouseover=i=>{i.stopPropagation()},this.handlePopupReposition=()=>{const i=this.host.renderRoot.querySelector("slot[name='submenu']"),s=i?.assignedElements({flatten:!0}).filter(h=>h.localName==="sl-menu")[0],o=getComputedStyle(this.host).direction==="rtl";if(!s)return;const{left:a,top:n,width:d,height:c}=s.getBoundingClientRect();this.host.style.setProperty("--safe-triangle-submenu-start-x",`${o?a+d:a}px`),this.host.style.setProperty("--safe-triangle-submenu-start-y",`${n}px`),this.host.style.setProperty("--safe-triangle-submenu-end-x",`${o?a+d:a}px`),this.host.style.setProperty("--safe-triangle-submenu-end-y",`${n+c}px`)},(this.host=t).addController(this),this.hasSlotController=e}hostConnected(){this.hasSlotController.test("submenu")&&!this.host.disabled&&this.addListeners()}hostDisconnected(){this.removeListeners()}hostUpdated(){this.hasSlotController.test("submenu")&&!this.host.disabled?(this.addListeners(),this.updateSkidding()):this.removeListeners()}addListeners(){this.isConnected||(this.host.addEventListener("mousemove",this.handleMouseMove),this.host.addEventListener("mouseover",this.handleMouseOver),this.host.addEventListener("keydown",this.handleKeyDown),this.host.addEventListener("click",this.handleClick),this.host.addEventListener("focusout",this.handleFocusOut),this.isConnected=!0),this.isPopupConnected||this.popupRef.value&&(this.popupRef.value.addEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.addEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=!0)}removeListeners(){this.isConnected&&(this.host.removeEventListener("mousemove",this.handleMouseMove),this.host.removeEventListener("mouseover",this.handleMouseOver),this.host.removeEventListener("keydown",this.handleKeyDown),this.host.removeEventListener("click",this.handleClick),this.host.removeEventListener("focusout",this.handleFocusOut),this.isConnected=!1),this.isPopupConnected&&this.popupRef.value&&(this.popupRef.value.removeEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.removeEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=!1)}handleSubmenuEntry(t){const e=this.host.renderRoot.querySelector("slot[name='submenu']");if(!e){console.error("Cannot activate a submenu if no corresponding menuitem can be found.",this);return}let i=null;for(const s of e.assignedElements())if(i=s.querySelectorAll("sl-menu-item, [role^='menuitem']"),i.length!==0)break;if(!(!i||i.length===0)){i[0].setAttribute("tabindex","0");for(let s=1;s!==i.length;++s)i[s].setAttribute("tabindex","-1");this.popupRef.value&&(t.preventDefault(),t.stopPropagation(),this.popupRef.value.active?i[0]instanceof HTMLElement&&i[0].focus():(this.enableSubmenu(!1),this.host.updateComplete.then(()=>{i[0]instanceof HTMLElement&&i[0].focus()}),this.host.requestUpdate()))}}setSubmenuState(t){this.popupRef.value&&this.popupRef.value.active!==t&&(this.popupRef.value.active=t,this.host.requestUpdate())}enableSubmenu(t=!0){t?(window.clearTimeout(this.enableSubmenuTimer),this.enableSubmenuTimer=window.setTimeout(()=>{this.setSubmenuState(!0)},this.submenuOpenDelay)):this.setSubmenuState(!0)}disableSubmenu(){window.clearTimeout(this.enableSubmenuTimer),this.setSubmenuState(!1)}updateSkidding(){var t;if(!((t=this.host.parentElement)!=null&&t.computedStyleMap))return;const e=this.host.parentElement.computedStyleMap(),s=["padding-top","border-top-width","margin-top"].reduce((o,a)=>{var n;const d=(n=e.get(a))!=null?n:new CSSUnitValue(0,"px"),h=(d instanceof CSSUnitValue?d:new CSSUnitValue(0,"px")).to("px");return o-h.value},0);this.skidding=s}isExpanded(){return this.popupRef.value?this.popupRef.value.active:!1}renderSubmenu(){const t=getComputedStyle(this.host).direction==="rtl";return this.isConnected?y`
    ...
    `}};St.styles=[L,In];St.dependencies={"sl-icon":j,"sl-popup":U,"sl-spinner":ai};r([k("slot:not([name])")],St.prototype,"defaultSlot",2);r([k(".menu-item")],St.prototype,"menuItem",2);r([l()],St.prototype,"type",2);r([l({type:Boolean,reflect:!0})],St.prototype,"checked",2);r([l()],St.prototype,"value",2);r([l({type:Boolean,reflect:!0})],St.prototype,"loading",2);r([l({type:Boolean,reflect:!0})],St.prototype,"disabled",2);r([x("checked")],St.prototype,"handleCheckedChange",1);r([x("disabled")],St.prototype,"handleDisabledChange",1);r([x("type")],St.prototype,"handleTypeChange",1);St.define("sl-menu-item");var Bn=T`
  :host {
    --divider-width: 2px;
    --handle-size: 2.5rem;
...
`,Ri=class extends z{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}};Ri.styles=[L,Un];r([l({type:Boolean,reflect:!0})],Ri.prototype,"vertical",2);r([x("vertical")],Ri.prototype,"handleVerticalChange",1);Ri.define("sl-divider");var Wn=T`
  :host {
    --size: 25rem;
...
`,Js=new WeakMap;function Bo(t){let e=Js.get(t);return e||(e=window.getComputedStyle(t,null),Js.set(t,e)),e}function qn(t){if(typeof t.checkVisibility=="function")return t.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=Bo(t);return e.visibility!=="hidden"&&e.display!=="none"}function jn(t){const e=Bo(t),{overflowY:i,overflowX:s}=e;return i==="scroll"||s==="scroll"?!0:i!=="auto"||s!=="auto"?!1:t.scrollHeight>t.clientHeight&&i==="auto"||t.scrollWidth>t.clientWidth&&s==="auto"}function Kn(t){const e=t.tagName.toLowerCase(),i=Number(t.getAttribute("tabindex"));return t.hasAttribute("tabindex")&&(isNaN(i)||i<=-1)||t.hasAttribute("disabled")||t.closest("[inert]")||e==="input"&&t.getAttribute("type")==="radio"&&!t.hasAttribute("checked")||!qn(t)?!1:(e==="audio"||e==="video")&&t.hasAttribute("controls")||t.hasAttribute("tabindex")||t.hasAttribute("contenteditable")&&t.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:jn(t)}function Yn(t){var e,i;const s=as(t),o=(e=s[0])!=null?e:null,a=(i=s[s.length-1])!=null?i:null;return{start:o,end:a}}function Xn(t,e){var i;return((i=t.getRootNode({composed:!0}))==null?void 0:i.host)!==e}function as(t){const e=new WeakMap,i=[];function s(o){if(o instanceof Element){if(o.hasAttribute("inert")||o.closest("[inert]")||e.has(o))return;e.set(o,!0),!i.includes(o)&&Kn(o)&&i.push(o),o instanceof HTMLSlotElement&&Xn(o,t)&&o.assignedElements({flatten:!0}).forEach(a=>{s(a)}),o.shadowRoot!==null&&o.shadowRoot.mode==="open"&&s(o.shadowRoot)}for(const a of o.children)s(a)}return s(t),i.sort((o,a)=>{const n=Number(o.getAttribute("tabindex"))||0;return(Number(a.getAttribute("tabindex"))||0)-n})}function*$s(t=document.activeElement){t!=null&&(yield t,"shadowRoot"in t&&t.shadowRoot&&t.shadowRoot.mode!=="closed"&&(yield*ir($s(t.shadowRoot.activeElement))))}function Gn(){return[...$s()].pop()}var He=[],Ho=class{constructor(t){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=e=>{var i;if(e.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const s=Gn();if(this.previousFocus=s,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;e.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const o=as(this.element);let a=o.findIndex(d=>d===s);this.previousFocus=this.currentFocus;const n=this.tabDirection==="forward"?1:-1;for(;;){a+n>=o.length?a=0:a+n<0?a=o.length-1:a+=n,this.previousFocus=this.currentFocus;const d=o[a];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||d&&this.possiblyHasTabbableChildren(d))return;e.preventDefault(),this.currentFocus=d,(i=this.currentFocus)==null||i.focus({preventScroll:!1});const c=[...$s()];if(c.includes(this.currentFocus)||!c.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=t,this.elementsWithTabbableControls=["iframe"]}activate(){He.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){He=He.filter(t=>t!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return He[He.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const t=as(this.element);if(!this.element.matches(":focus-within")){const e=t[0],i=t[t.length-1],s=this.tabDirection==="forward"?e:i;typeof s?.focus=="function"&&(this.currentFocus=s,s.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(t){return this.elementsWithTabbableControls.includes(t.tagName.toLowerCase())||t.hasAttribute("controls")}};function to(t){return t.charAt(0).toUpperCase()+t.slice(1)}var At=class extends z{constructor(){super(...arguments),this.hasSlotController=new vt(this,"footer"),this.localize=new H(this),this.modal=new Ho(this),this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=t=>{this.contained||t.key==="Escape"&&this.modal.isActive()&&this.open&&(t.stopImmediatePropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),qe(this)))}disconnectedCallback(){super.disconnectedCallback(),je(this),this.removeOpenListeners()}requestClose(t){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){const i=Y(this,"drawer.denyClose",{dir:this.localize.dir()});Q(this.panel,i.keyframes,i.options);return}this.hide()}addOpenListeners(){var t;"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var t;document.removeEventListener("keydown",this.handleDocumentKeyDown),(t=this.closeWatcher)==null||t.destroy()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),qe(this));const t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([st(this.drawer),st(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")});const e=Y(this,`drawer.show${to(this.placement)}`,{dir:this.localize.dir()}),i=Y(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([Q(this.panel,e.keyframes,e.options),Q(this.overlay,i.keyframes,i.options)]),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),je(this)),await Promise.all([st(this.drawer),st(this.overlay)]);const t=Y(this,`drawer.hide${to(this.placement)}`,{dir:this.localize.dir()}),e=Y(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([Q(this.overlay,e.keyframes,e.options).then(()=>{this.overlay.hidden=!0}),Q(this.panel,t.keyframes,t.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;const i=this.originalTrigger;typeof i?.focus=="function"&&setTimeout(()=>i.focus()),this.emit("sl-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),qe(this)),this.open&&this.contained&&(this.modal.deactivate(),je(this))}async show(){if(!this.open)return this.open=!0,bt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,bt(this,"sl-after-hide")}render(){return y`
      <div
        part="base"
...
`,pt=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.open=!1,this.placement="bottom-start",this.disabled=!1,this.stayOpenOnSelect=!1,this.distance=0,this.skidding=0,this.hoist=!1,this.sync=void 0,this.handleKeyDown=t=>{this.open&&t.key==="Escape"&&(t.stopPropagation(),this.hide(),this.focusOnTrigger())},this.handleDocumentKeyDown=t=>{var e;if(t.key==="Escape"&&this.open&&!this.closeWatcher){t.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(t.key==="Tab"){if(this.open&&((e=document.activeElement)==null?void 0:e.tagName.toLowerCase())==="sl-menu-item"){t.preventDefault(),this.hide(),this.focusOnTrigger();return}setTimeout(()=>{var i,s,o;const a=((i=this.containingElement)==null?void 0:i.getRootNode())instanceof ShadowRoot?(o=(s=document.activeElement)==null?void 0:s.shadowRoot)==null?void 0:o.activeElement:document.activeElement;(!this.containingElement||a?.closest(this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}},this.handleDocumentMouseDown=t=>{const e=t.composedPath();this.containingElement&&!e.includes(this.containingElement)&&this.hide()},this.handlePanelSelect=t=>{const e=t.target;!this.stayOpenOnSelect&&e.tagName.toLowerCase()==="sl-menu"&&(this.hide(),this.focusOnTrigger())}}connectedCallback(){super.connectedCallback(),this.containingElement||(this.containingElement=this)}firstUpdated(){this.panel.hidden=!this.open,this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){const t=this.trigger.assignedElements({flatten:!0})[0];typeof t?.focus=="function"&&t.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(t=>t.tagName.toLowerCase()==="sl-menu")}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(t){if([" ","Enter"].includes(t.key)){t.preventDefault(),this.handleTriggerClick();return}const e=this.getMenu();if(e){const i=e.getAllItems(),s=i[0],o=i[i.length-1];["ArrowDown","ArrowUp","Home","End"].includes(t.key)&&(t.preventDefault(),this.open||(this.show(),await this.updateComplete),i.length>0&&this.updateComplete.then(()=>{(t.key==="ArrowDown"||t.key==="Home")&&(e.setCurrentItem(s),s.focus()),(t.key==="ArrowUp"||t.key==="End")&&(e.setCurrentItem(o),o.focus())}))}}handleTriggerKeyUp(t){t.key===" "&&t.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){const e=this.trigger.assignedElements({flatten:!0}).find(s=>Yn(s).start);let i;if(e){switch(e.tagName.toLowerCase()){case"sl-button":case"sl-icon-button":i=e.button;break;default:i=e}i.setAttribute("aria-haspopup","true"),i.setAttribute("aria-expanded",this.open?"true":"false")}}async show(){if(!this.open)return this.open=!0,bt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,bt(this,"sl-after-hide")}reposition(){this.popup.reposition()}addOpenListeners(){var t;this.panel.addEventListener("sl-select",this.handlePanelSelect),"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown)}removeOpenListeners(){var t;this.panel&&(this.panel.removeEventListener("sl-select",this.handlePanelSelect),this.panel.removeEventListener("keydown",this.handleKeyDown)),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),(t=this.closeWatcher)==null||t.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}if(this.updateAccessibleTrigger(),this.open){this.emit("sl-show"),this.addOpenListeners(),await st(this),this.panel.hidden=!1,this.popup.active=!0;const{keyframes:t,options:e}=Y(this,"dropdown.show",{dir:this.localize.dir()});await Q(this.popup.popup,t,e),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),await st(this);const{keyframes:t,options:e}=Y(this,"dropdown.hide",{dir:this.localize.dir()});await Q(this.popup.popup,t,e),this.panel.hidden=!0,this.popup.active=!1,this.emit("sl-after-hide")}}render(){return y`
      <sl-popup
        part="base"
...
`,Xt=class extends z{constructor(){super(...arguments),this.hasSlotController=new vt(this,"footer"),this.localize=new H(this),this.modal=new Ho(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=t=>{t.key==="Escape"&&this.modal.isActive()&&this.open&&(t.stopPropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),qe(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),je(this),this.removeOpenListeners()}requestClose(t){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){const i=Y(this,"dialog.denyClose",{dir:this.localize.dir()});Q(this.panel,i.keyframes,i.options);return}this.hide()}addOpenListeners(){var t;"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var t;(t=this.closeWatcher)==null||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),qe(this);const t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([st(this.dialog),st(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")});const e=Y(this,"dialog.show",{dir:this.localize.dir()}),i=Y(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([Q(this.panel,e.keyframes,e.options),Q(this.overlay,i.keyframes,i.options)]),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([st(this.dialog),st(this.overlay)]);const t=Y(this,"dialog.hide",{dir:this.localize.dir()}),e=Y(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([Q(this.overlay,e.keyframes,e.options).then(()=>{this.overlay.hidden=!0}),Q(this.panel,t.keyframes,t.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,je(this);const i=this.originalTrigger;typeof i?.focus=="function"&&setTimeout(()=>i.focus()),this.emit("sl-after-hide")}}async show(){if(!this.open)return this.open=!0,bt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,bt(this,"sl-after-hide")}render(){return y`
    ...
    `}};Xt.styles=[L,tl];Xt.dependencies={"sl-icon-button":at};r([k(".dialog")],Xt.prototype,"dialog",2);r([k(".dialog__panel")],Xt.prototype,"panel",2);r([k(".dialog__overlay")],Xt.prototype,"overlay",2);r([l({type:Boolean,reflect:!0})],Xt.prototype,"open",2);r([l({reflect:!0})],Xt.prototype,"label",2);r([l({attribute:"no-header",type:Boolean,reflect:!0})],Xt.prototype,"noHeader",2);r([x("open",{waitUntilFirstUpdate:!0})],Xt.prototype,"handleOpenChange",1);W("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});W("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});W("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});W("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});W("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Xt.define("sl-dialog");rt.define("sl-checkbox");var el=T`
  :host {
    --grid-width: 280px;
    --grid-height: 200px;
...
`,q=class extends z{constructor(){super(...arguments),this.formControlController=new Zt(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new vt(this,"[default]","prefix","suffix"),this.localize=new H(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Ei}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(t){this.isButton()&&(this.button.setCustomValidity(t),this.formControlController.updateValidity())}render(){const t=this.isLink(),e=t?zi`a`:zi`button`;return Ke`
    ...
    `}};B.styles=[L,el];B.dependencies={"sl-button-group":ye,"sl-button":q,"sl-dropdown":pt,"sl-icon":j,"sl-input":R,"sl-visually-hidden":fs};r([k('[part~="base"]')],B.prototype,"base",2);r([k('[part~="input"]')],B.prototype,"input",2);r([k(".color-dropdown")],B.prototype,"dropdown",2);r([k('[part~="preview"]')],B.prototype,"previewButton",2);r([k('[part~="trigger"]')],B.prototype,"trigger",2);r([I()],B.prototype,"hasFocus",2);r([I()],B.prototype,"isDraggingGridHandle",2);r([I()],B.prototype,"isEmpty",2);r([I()],B.prototype,"inputValue",2);r([I()],B.prototype,"hue",2);r([I()],B.prototype,"saturation",2);r([I()],B.prototype,"brightness",2);r([I()],B.prototype,"alpha",2);r([l()],B.prototype,"value",2);r([Ie()],B.prototype,"defaultValue",2);r([l()],B.prototype,"label",2);r([l()],B.prototype,"format",2);r([l({type:Boolean,reflect:!0})],B.prototype,"inline",2);r([l({reflect:!0})],B.prototype,"size",2);r([l({attribute:"no-format-toggle",type:Boolean})],B.prototype,"noFormatToggle",2);r([l()],B.prototype,"name",2);r([l({type:Boolean,reflect:!0})],B.prototype,"disabled",2);r([l({type:Boolean})],B.prototype,"hoist",2);r([l({type:Boolean})],B.prototype,"opacity",2);r([l({type:Boolean})],B.prototype,"uppercase",2);r([l()],B.prototype,"swatches",2);r([l({reflect:!0})],B.prototype,"form",2);r([l({type:Boolean,reflect:!0})],B.prototype,"required",2);r([ii({passive:!1})],B.prototype,"handleTouchMove",1);r([x("format",{waitUntilFirstUpdate:!0})],B.prototype,"handleFormatChange",1);r([x("opacity",{waitUntilFirstUpdate:!0})],B.prototype,"handleOpacityChange",1);r([x("value")],B.prototype,"handleValueChange",1);B.define("sl-color-picker");var ml=T`
  :host {
    --border-color: var(--sl-color-neutral-200);
    --border-radius: var(--sl-border-radius-medium);
    --border-width: 1px;
...
`,Uo=class extends z{constructor(){super(...arguments),this.hasSlotController=new vt(this,"footer","header","image")}render(){return y`
      <div
        part="base"
      ...
      <div part="base" class="carousel">
        ...
        ${this.pagination?y`
              <div part="pagination" role="tablist" class="carousel__pagination" aria-controls="scroll-container">
                ${vl(yl(i),d=>{const c=d===s;return y`
                    <button
...
`,Wo=class extends z{connectedCallback(){super.connectedCallback(),this.setAttribute("role","group")}render(){return y` <slot></slot> `}};Wo.styles=[L,xl];Wo.define("sl-carousel-item");q.define("sl-button");ye.define("sl-button-group");var kl=T`
  .breadcrumb {
    display: flex;
    align-items: center;
    flex-wrap: wrap;
...
`,De=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.separatorDir=this.localize.dir(),this.label=""}getSeparator(){const e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll("[id]")].forEach(i=>i.removeAttribute("id")),e.setAttribute("data-default",""),e.slot="separator",e}handleSlotChange(){const t=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()==="sl-breadcrumb-item");t.forEach((e,i)=>{const s=e.querySelector('[slot="separator"]');s===null?e.append(this.getSeparator()):s.hasAttribute("data-default")&&s.replaceWith(this.getSeparator()),i===t.length-1?e.setAttribute("aria-current","page"):e.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),y`
    ...
    `}};De.styles=[L,kl];De.dependencies={"sl-icon":j};r([k("slot")],De.prototype,"defaultSlot",2);r([k('slot[name="separator"]')],De.prototype,"separatorSlot",2);r([l()],De.prototype,"label",2);De.define("sl-breadcrumb");var Cl=T`
  :host {
    display: inline-flex;
  }
...
`,di=class extends z{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return y`
    ...
    `}};di.styles=[L,Cl];r([l({reflect:!0})],di.prototype,"variant",2);r([l({type:Boolean,reflect:!0})],di.prototype,"pill",2);r([l({type:Boolean,reflect:!0})],di.prototype,"pulse",2);di.define("sl-badge");var $l=T`
  :host {
    display: inline-flex;
  }
...
`,Gt=class extends z{constructor(){super(...arguments),this.hasError=!1,this.image="",this.label="",this.initials="",this.loading="eager",this.shape="circle"}handleImageChange(){this.hasError=!1}handleImageLoadError(){this.hasError=!0,this.emit("sl-error")}render(){const t=y`
    ...
    `}};Gt.styles=[L,vd];Gt.dependencies={"sl-icon":j};r([I()],Gt.prototype,"hasError",2);r([l()],Gt.prototype,"image",2);r([l()],Gt.prototype,"label",2);r([l()],Gt.prototype,"initials",2);r([l()],Gt.prototype,"loading",2);r([l({reflect:!0})],Gt.prototype,"shape",2);r([x("image")],Gt.prototype,"handleImageChange",1);Gt.define("sl-avatar");var yd=T`
  :host {
    display: contents;
...
`,we=Object.assign(document.createElement("div"),{className:"sl-toast-stack"}),Et=class extends z{constructor(){super(...arguments),this.hasSlotController=new vt(this,"icon","suffix"),this.localize=new H(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var t;(t=this.countdownAnimation)==null||t.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var t;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(t=this.countdownAnimation)==null||t.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:t}=this,e="100%",i="0";this.countdownAnimation=t.animate([{width:e},{width:i}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await st(this.base),this.base.hidden=!1;const{keyframes:t,options:e}=Y(this,"alert.show",{dir:this.localize.dir()});await Q(this.base,t,e),this.emit("sl-after-show")}else{this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await st(this.base);const{keyframes:t,options:e}=Y(this,"alert.hide",{dir:this.localize.dir()});await Q(this.base,t,e),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,bt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,bt(this,"sl-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),we.parentElement===null&&document.body.append(we),we.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{we.removeChild(this),t(),we.querySelector("sl-alert")===null&&we.remove()},{once:!0})})}render(){return y`
    ...
    `}};Et.styles=[L,yd];Et.dependencies={"sl-icon-button":at};r([k('[part~="base"]')],Et.prototype,"base",2);r([k(".alert__countdown-elapsed")],Et.prototype,"countdownElement",2);r([l({type:Boolean,reflect:!0})],Et.prototype,"open",2);r([l({type:Boolean,reflect:!0})],Et.prototype,"closable",2);r([l({reflect:!0})],Et.prototype,"variant",2);r([l({type:Number})],Et.prototype,"duration",2);r([l({type:String,reflect:!0})],Et.prototype,"countdown",2);r([I()],Et.prototype,"remainingTime",2);r([x("open",{waitUntilFirstUpdate:!0})],Et.prototype,"handleOpenChange",1);r([x("duration")],Et.prototype,"handleDurationChange",1);W("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});W("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});Et.define("sl-alert");var _d=T`
  :host {
